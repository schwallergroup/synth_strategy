...
You MUST wrap the code in <code> ... </code> tags otherwise it will not work with the environment used to run it.
</code>

This is essential because I use the following code for parsing:
...
You must return the final code draft within <code></code> tags. 
"""
