        ...
        if (
            ...
            try:
                ...
                if not is_c_n_coupling:
                    ...
                    reactant_mols = [
                        Chem.MolFromSmiles(smi) for smi in reactants_smiles if smi
                    ]
                    product_mol = (
                    ...
                    if all(reactant_mols) and product_mol:
                        ...
                        if not is_c_n_coupling and checker.check_fg(
                            "Aniline", product_smiles
                        ):
                            # Check if aniline was not present in reactants
                            if not any(
                                checker.check_fg("Aniline", r) for r in reactants_smiles
                            ):
                                is_c_n_coupling = True
