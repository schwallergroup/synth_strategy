    ...
    def dfs_traverse(node, depth=0):
        ...
        if (
            ...
            if depth <= 3:
                ...
                print(
                    f"Is silyl protection reaction (from checker): {is_silyl_protection}"
                )

                # If not detected by the checker, try manual detection
                if not is_silyl_protection:
                    is_silyl_protection = manual_silyl_protection_check(
                        reactants, product
                    )
                    print(
                ...
                if is_silyl_protection:
                    ...
                    has_alcohol_reactant = any(
                        any(
                            checker.check_fg(alcohol_type, r)
                    ...
                    if has_alcohol_reactant and has_silyl_ether_product:
                        ...
                        print(
                            f"Found late-stage silyl protection reaction at depth {depth}"
                        )
