    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "reaction":
            ...
            if not benzoxazole_formed:
                ...
                try:
                    product_has_benzoxazole = checker.check_ring(
                        "benzoxazole", product_smiles
                    )
            ...
            if depth <= 1:
                ...
                if checker.check_reaction("Reduction of nitro groups to amines", rsmi):
                    ...
                    try:
                        ...
                        product_has_no_nitro = not checker.check_fg(
                        ...
                        if (
                            ...
                            print(
                                f"Late-stage nitro reduction detected at depth: {depth}"
                            )
                            late_nitro_reduction = True
                    except Exception as e:
