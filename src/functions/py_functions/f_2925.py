                ...
                try:
                    ...
                    for reactant in reactants:
                        if checker.check_fg(
                            ...
                            print(
                                f"{indent}Found boronic acid/ester in reactant: {reactant}"
                            )
                            has_boronic = True
                        ...
                        if checker.check_fg("Aromatic halide", reactant):
                            print(
                                f"{indent}Found aromatic halide in reactant: {reactant}"
                            )
                    ...
                    if has_boronic and has_aryl_halide:
                        print(
                            f"{indent}Detected Suzuki coupling pattern manually: {rsmi}"
                        )
                        suzuki_found = True
