...
def main(route):
    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "reaction":
            ...
            if (
                phenol_present or chloroformate_present
    ...
    early_stage_threshold = (
        max_depth * 0.6
    )  # Consider early stage if in the top 60% of depth
    strategy_present = (
        carbamate_formation_depth is not None
        and carbamate_formation_depth >= early_stage_threshold
    )
