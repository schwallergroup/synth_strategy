            ...
            try:
                ...
                for reaction_type in heterocycle_reactions:
                    if checker.check_reaction(reaction_type, rsmi):
                        print(
                            f"Heterocycle formation reaction detected: {reaction_type}"
                        )
                ...
                if checker.check_ring("benzofuran", product_smiles):
                    ...
                    if any(
                        checker.check_fg("Phenol", r) for r in reactants_smiles
                    ) and any(
                        ...
                        print(
                            f"Benzofuran formation detected from phenol and halide: {rsmi}"
                        )
                        heterocycle_construction_detected = True
                        return
