    ...
    def dfs_traverse(node):
        ...
        if node["type"] == "mol":
            ...
            if mol:
                ...
                ) and not mol.HasSubstructMatch(Chem.MolFromSmarts("[C](=O)-[N]-[OH]")):
            ...
            if "metadata" in node and "rsmi" in node["metadata"]:
                ...
                if product_mol and any(r for r in reactant_mols):
                    ...
                    if (
                        any(
                            r
                            and r.HasSubstructMatch(Chem.MolFromSmarts("[C]=[N]-[OH]"))
                            for r in reactant_mols
                            if r
                        )
                        and product_mol.HasSubstructMatch(
                            Chem.MolFromSmarts("[NH]-[OH]")
                        )
                    ...
                    if any(
                        ...
                        print(
                            f"Found hydroxylamine to N-hydroxy amide transformation: {rsmi}"
                        )
