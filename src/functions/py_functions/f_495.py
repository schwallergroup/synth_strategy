                ...
                if checker.check_fg("Ester", product):
                    ...
                    if ester_reactant:
                        ...
                        if product_mol and ester_mol:
                            ...
                            if (
                                "[CH2:5]" in ester_reactant
                                and "[CH:5]([CH3:6])" in product
                            ):
                                alpha_alkylation_found = True
                                print(
                                    "α-alkylation of ester detected - methyl group added"
                                )
                                return

                            # Second check: More general alpha carbon pattern
                            alpha_pattern = Chem.MolFromSmarts(
                                "[C:1]([H])([#6,#1,*])(C(=O)O[#6])"
                            )
                            if ester_mol.HasSubstructMatch(alpha_pattern):
                                ester_matches = ester_mol.GetSubstructMatches(
                                    alpha_pattern
                                )
                                print(
                                    f"Found alpha carbon in ester reactant: {ester_matches}"
                                )
                                ...
                                for match in ester_matches:
                                    ...
                                    if alpha_atom.GetAtomMapNum() > 0:
                                        alpha_carbon_map_num = (
                                            alpha_atom.GetAtomMapNum()
                                        )
                                        print(
                                            f"Alpha carbon map number: {alpha_carbon_map_num}"
                                        )
                                        ...
                                        if alpha_carbon_in_product:
                                            ...
                                            if (
                                                product_heavy_neighbors
                                                > reactant_heavy_neighbors
                                            ):
                                                alpha_alkylation_found = True
                                                print(
                                            ...
                                            reactant_h_count = (
                                                reactant_alpha.GetTotalNumHs(
                                                    includeNeighbors=True
                                                )
                                            )
                                            product_h_count = (
                                                alpha_carbon_in_product.GetTotalNumHs(
                                                    includeNeighbors=True
                                                )
                                            )
                            ...
                            alpha_subst_pattern = Chem.MolFromSmarts(
                                "[CH]([#6])(C(=O)O[#6])"
                            )
                            ...
                            if ester_mol.HasSubstructMatch(
                                ...
                                alpha_alkylation_found = True
                                print(
                                    "α-alkylation of ester detected - CH2 to CH-R pattern"
                                )
                                return
