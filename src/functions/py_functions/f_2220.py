...
def main(route):
            ...
            try:
                ...
                if not is_reduction and not is_oxidation:
                    ...
                    if any(
                        ...
                        reaction_sequence.append(("reduction", depth))
                        print(
                            f"Detected reduction: Aldehyde to primary alcohol at depth {depth}"
                        )
                        ...
                        reaction_sequence.append(("reduction", depth))
                        print(
                            f"Detected reduction: Ketone to secondary alcohol at depth {depth}"
                        )
                    ...
                    # Additional oxidation checks based on functional groups
                        ...
                        reaction_sequence.append(("oxidation", depth))
                        print(
                            f"Detected oxidation: Primary alcohol to aldehyde at depth {depth}"
                        )
                        ...
                        reaction_sequence.append(("oxidation", depth))
                        print(
                            f"Detected oxidation: Secondary alcohol to ketone at depth {depth}"
                        )
                        ...
                        reaction_sequence.append(("oxidation", depth))
                        print(
                            f"Detected oxidation: Aldehyde to carboxylic acid at depth {depth}"
                        )
    ...
    reduction_steps = sum(
        1 for step_type, _ in reaction_sequence if step_type == "reduction"
    )
    oxidation_steps = sum(
        1 for step_type, _ in reaction_sequence if step_type == "oxidation"
    )
