            ...
            if len(reactants) > 1 and depth <= 3:
                ...
                if not is_coupling:
                    ...
                    if any(
                        ...
                        print(
                            "Detected potential Buchwald-Hartwig-like coupling pattern"
                        )
                        is_coupling = True
                    # Check for guanidine-like coupling patterns
                    elif any("C(=N)" in r for r in reactants) and any(
                        "NH" in r for r in reactants
                    ):
                ...
                for i, r in enumerate(reactants):
                    ...
                    if mol:
                        ...
                        fg_count = sum(
                            1 for fg in complexity_fgs if checker.check_fg(fg, r)
                        )

                        # Count complex rings
                        complex_ring_count = sum(
                            1
                            for ring in complexity_rings
                        ...
                        if (
                            ...
                            for i, (idx1, r1, mol1) in enumerate(complex_reactants):
                                for idx2, r2, mol2 in complex_reactants[i + 1 :]:
                                    print(
                                        f"Checking coupling between reactants {idx1} and {idx2}"
                                    )
                                    ...
                                    if mcs1.numAtoms > 0 and mcs2.numAtoms > 0:
                                        ...
                                        print(
                                            f"MCS ratios: {mcs1_ratio:.2f}, {mcs2_ratio:.2f}"
                                        )
