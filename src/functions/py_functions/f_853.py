        ...
        if node["type"] == "mol" and "smiles" in node:
            ...
            try:
                ...
                if depth == 0:
                    ...
                    print(
                        f"Has thiopyran: {has_thiopyran}, Has thiazole: {has_thiazole}"
                    )
                        ...
                        if mol:
                            ...
                            if (
                                ...
                                if mol.HasSubstructMatch(sulfonyl_thiazolone):
                                    final_product_has_thiazinone = True
                                    print(
                                        "Found sulfonyl-modified thiazolone structure"
                                    )
                                else:
                                    print(
                            ...
                            print(
                                f"Could not create RDKit molecule from SMILES: {smiles}"
                            )
                    else:
                        # Direct check for the specific structure in the test case
                        mol = Chem.MolFromSmiles(smiles)
