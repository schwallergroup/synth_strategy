    ...
    def dfs_traverse(node, depth=0):
        ...
        if (
            ...
            if checker.check_reaction("Preparation of organolithium compounds", rsmi):
                ...
                for sibling in node.get("children", []):
                    if (
                        ...
                        if has_aldehyde and checker.check_fg(
                            "Secondary alcohol", product
                        ):
                            print(
                                f"Found organolithium addition to aldehyde at depth {depth+1}"
                            )
                            found_addition = True
                            return
            ...
            if has_halide and has_aldehyde and has_sec_alcohol:
                print(
                    f"Found potential Grignard/organolithium addition at depth {depth}"
                )
                found_addition = True
