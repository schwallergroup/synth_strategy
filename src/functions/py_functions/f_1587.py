    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "reaction":
            if "rsmi" in node.get("metadata", {}):
                ...
                pyrazole_pattern = Chem.MolFromSmarts(
                    "c1nn(C)cc1"
                )  # Simplified N-methyl pyrazole
                ...
                for reactant in reactants:
                    ...
                    if reactant_mol.HasSubstructMatch(
                        ...
                        if not Chem.MolToSmiles(reactant_mol) == Chem.MolToSmiles(
                            product_mol
                        ):
                    ...
                    if (
                        "1" in reactant and "1" in product
                    ):  # Simple check for ring notation
