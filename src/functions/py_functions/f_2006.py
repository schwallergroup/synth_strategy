            ...
            if "metadata" in node and "rsmi" in node["metadata"]:
                ...
                try:
                    ...
                    for reactant in reactants:
                        for fg in carbonyl_fgs:
                            if checker.check_fg(fg, reactant):
                                ...
                                print(
                                    f"Found carbonyl group ({fg}) in reactant: {reactant}"
                                )
                                break
                        if carbonyl_found:
                            break
                    ...
                    if carbonyl_found and carbonyl_reactant:
                        ...
                        carbonyl_mol = (
                            Chem.MolFromSmiles(carbonyl_reactant)
                            if carbonyl_reactant
                            else None
                        )
                        ...
                        if product_mol and carbonyl_mol:
                            ...
                            for fg in carbonyl_fgs:
                                if checker.check_fg(
                                    fg, carbonyl_reactant
                                ) and not checker.check_fg(fg, product):
                                    print(
                                        f"Carbonyl group {fg} was consumed in the reaction"
                                    )
                                    carbonyl_addition_found = True
                                    return
