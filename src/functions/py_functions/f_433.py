...
def main(route):
    ...
    def dfs_traverse(node):
        ...
        if node["type"] == "mol" and "smiles" in node:
            try:
                ...
                if (
                    has_imidazole_in_mol
                    and "NS(=O)(=O)c" in mol_smiles
                    and "ccc3o" in mol_smiles
                ):
                    print(
    ...
    if molecules_with_both:
        print(
            f"Found {len(molecules_with_both)} molecules containing both heterocycles"
        )
        return True
            ...
            if (
                ...
                try:
                    ...
                    if product_has_imidazole and product_has_benzofuran:
                        print(
                            f"Found reaction producing a molecule with both heterocycles: {rsmi}"
                        )
                        return True
                    ...
                    reactants_with_benzofuran = [
                        r for r in reactants if check_benzofuran_like(r)
                    ]
