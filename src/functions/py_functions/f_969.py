    ...
    def dfs_traverse(node, current_depth=0):
        ...
        if node["type"] == "mol":
            ...
            if has_cyano:
                ...
                print(
                    f"Found cyano group in molecule at depth {current_depth}: {mol_smiles}"
                )
        ...
        # For reaction nodes, check if cyano is preserved from reactants to product
            ...
            try:
                ...
                if product_has_cyano:
                    cyano_at_depth[current_depth] = True
                    print(
                        f"Found cyano group in product at depth {current_depth}: {product}"
                    )
                ...
                if reactant_has_cyano and product_has_cyano:
                    ...
                    print(
                        f"Cyano group introduced in reaction at depth {current_depth}"
                    )
