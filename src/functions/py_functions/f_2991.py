            ...
            try:
                ...
                for rxn_type in oxidation_reactions:
                    if checker.check_reaction(rxn_type, rsmi):
                        is_oxidation = True
                        print(
                            f"Detected oxidation reaction '{rxn_type}' at depth {depth}"
                        )
                        break
                ...
                if not is_oxidation:
                    ...
                    if has_alcohol_in_product and (
                        ...
                        is_oxidation = True
                        print(
                            f"Detected oxidation by functional group change at depth {depth}"
                        )
                ...
                for rxn_type in reduction_reactions:
                    if checker.check_reaction(rxn_type, rsmi):
                        is_reduction = True
                        print(
                            f"Detected reduction reaction '{rxn_type}' at depth {depth}"
                        )
                        break
                ...
                if not is_reduction:
                    ...
                    has_alkene_in_product = checker.check_fg(
                        "Alkene", product
                    ...
                    if (
                        ...
                        is_reduction = True
                        print(
                            f"Detected reduction by functional group change at depth {depth}"
                        )
