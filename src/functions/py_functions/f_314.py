                    ...
                    try:
                        ...
                        if product_mol:
                            ...
                            reactants_br_count = sum(
                                len(
                                    [a for a in mol.GetAtoms() if a.GetSymbol() == "Br"]
                                )
                            ...
                            reactants_cl_count = sum(
                                len(
                                    [a for a in mol.GetAtoms() if a.GetSymbol() == "Cl"]
                                )
                                for mol in reactant_mols
                                if mol is not None
                            )
                            ...
                            new_halide_formed = (
                                product_br_count > reactants_br_count
                            ) or (product_cl_count > reactants_cl_count)

                            if new_halide_formed:
                                print(
                                    f"Halogenation via atom count detected at depth {depth}"
                                )
                                print(
