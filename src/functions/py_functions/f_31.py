        ...
        if (
            ...
            if depth <= 1:  # Late stage (depth 0 or 1)
                ...
                if checker.check_reaction("Williamson Ether Synthesis", rsmi):
                    ...
                    print(
                        f"Detected late-stage O-alkylation: Mitsunobu_phenole at depth {depth}"
                    )
                    late_stage_o_alkylation_detected = True
                    ...
                    print(
                        f"Detected late-stage O-alkylation: O-methylation at depth {depth}"
                    )
                    late_stage_o_alkylation_detected = True
                    ...
                    print(
                        f"Detected late-stage O-alkylation: Alcohol to ether at depth {depth}"
                    )
                    late_stage_o_alkylation_detected = True
                else:
                    ...
                    if (
                        has_alcohol_reactant
                        and has_alkylating_agent
                        and has_ether_product
                    ):
                        print(
                            f"Detected late-stage O-alkylation: General pattern at depth {depth}"
                        )
                        late_stage_o_alkylation_detected = True
