        ...
        if node["type"] == "reaction" and depth <= 3:  # Extended to depth 3
            try:
                ...
                # Halogenation/dehalogenation reactions
                    ...
                    late_stage_modifications += 1
                    print(
                        f"Late-stage halogenation/dehalogenation detected at depth {depth}"
                    )
                ...
                # Oxidation/reduction reactions
                    ...
                    or checker.check_reaction(
                        "Oxidation of amide to carboxylic acid", rsmi
                    )
                    or checker.check_reaction(
                ...
                # Protection/deprotection reactions
                    ...
                    late_stage_modifications += 1
                    print(
                        f"Late-stage protection/deprotection detected at depth {depth}"
                    )
                ...
                # Esterification/amidation reactions
                    ...
                    or checker.check_reaction(
                        "Acyl chloride with primary amine to imide", rsmi
                    )
                    or checker.check_reaction(
                    ...
                    late_stage_modifications += 1
                    print(
                        f"Late-stage esterification/amidation detected at depth {depth}"
                    )
                ...
                # Other functional group transformations
                    ...
                    or checker.check_reaction(
                        "Amine and thiophosgene to isothiocyanate", rsmi
                    )
                    ...
                    late_stage_modifications += 1
                    print(
                        f"Late-stage functional group transformation detected at depth {depth}"
                    )
                ...
                # If no specific reaction type was detected, check for functional group changes
                    ...
                    try:
                        ...
                        reactant_mols = [
                            Chem.MolFromSmiles(r) for r in reactants_smiles
                        ]
