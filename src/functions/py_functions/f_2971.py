        ...
        if node["type"] == "reaction" and depth > 1:  # Early stage (depth > 1)
            try:
                ...
                # Carboxylic acid to ester
                    ...
                    print(
                        f"Found carboxylic acid to ester transformation at depth {depth}"
                    )
                    has_early_fg_manipulation = True
                ...
                # Aldehyde to carboxylic acid oxidation
                    ...
                    print(
                        f"Found aldehyde to carboxylic acid oxidation at depth {depth}"
                    )
                    has_early_fg_manipulation = True
                ...
                # Secondary alcohol to ketone oxidation
                    ...
                    print(
                        f"Found secondary alcohol to ketone oxidation at depth {depth}"
                    )
                    has_early_fg_manipulation = True
                ...
                # Ketone to secondary alcohol reduction
                    ...
                    print(
                        f"Found ketone to secondary alcohol reduction at depth {depth}"
                    )
                    has_early_fg_manipulation = True
                ...
                # Alcohol to carboxylic acid oxidation
                    ...
                    print(
                        f"Found alcohol to carboxylic acid oxidation at depth {depth}"
                    )
                    has_early_fg_manipulation = True
                ...
                # Carboxylic acid to alcohol reduction
                    ...
                    print(
                        f"Found carboxylic acid to alcohol reduction at depth {depth}"
                    )
                    has_early_fg_manipulation = True
                ...
                # Nitrile to carboxylic acid hydrolysis
                    ...
                    print(
                        f"Found nitrile to carboxylic acid hydrolysis at depth {depth}"
                    )
                    has_early_fg_manipulation = True
