...
def main(route):
        ...
        if node["type"] == "reaction":
            if "rsmi" in node.get("metadata", {}):
                ...
                if any(
                    ...
                    print(
                        f"Found alcohol to mesylate/triflate transformation at depth {depth}"
                    )
                ...
                if any(
                    ...
                    print(
                        f"Found mesylate/triflate to azide transformation at depth {depth}"
                    )
    ...
    if not all(
        ...
        for t in [
            "alcohol_to_leaving_group",
            "leaving_group_to_azide",
            "azide_to_amine",
        ]
    ):
