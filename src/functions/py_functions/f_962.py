        ...
        if (
            ...
            for reaction_type in oxidation_reactions:
                if checker.check_reaction(reaction_type, rsmi):
                    print(
                        f"Oxidation reaction detected: {reaction_type} at depth {depth}"
                    )
            ...
            if not oxidation_depths or depth not in oxidation_depths:
                ...
                if alcohol_in_reactants and (
                    aldehyde_in_product or carboxylic_acid_in_product
                ):
    ...
    if oxidation_depths:
        ...
        for depth in oxidation_depths:
            if depth <= half_depth:  # First half of synthesis (late stage)
                ...
                print(
                    f"Late-stage oxidation found at depth {depth} (max depth: {max_depth})"
                )
                break
