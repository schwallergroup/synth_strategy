...
def main(route):
        ...
        if node["type"] == "reaction":
            if "rsmi" in node.get("metadata", {}):
                ...
                if checker.check_reaction(
                    "Aromatic substitution of bromine by chlorine", rsmi
                ):
                    print(
                ...
                for rxn_type in halogenation_reactions:
                    if checker.check_reaction(rxn_type, rsmi):
                        print(
                            f"Detected halogenation reaction: {rxn_type} at depth {depth}"
                        )
                        return True
                    ...
                    if reactant.strip():
                        try:
                            ...
                            for halogen in ["I", "Br", "Cl", "F"]:
                                ...
                                if checker.check_fg(
                                    f"Primary {halogen.lower()}ide", reactant
                                ):
                                ...
                                if checker.check_fg(
                                    f"Secondary {halogen.lower()}ide", reactant
                                ):
                                    reactant_halogens[halogen] = (
                                        reactant_halogens.get(halogen, 0) + 1
                                    )
                                ...
                                if checker.check_fg(
                                    f"Tertiary {halogen.lower()}ide", reactant
                                ):
                                    reactant_halogens[halogen] = (
                                        reactant_halogens.get(halogen, 0) + 1
                                    )
                                ...
                                if checker.check_fg(
                                    f"Aromatic {halogen.lower()}ide", reactant
                                ):
                                    reactant_halogens[halogen] = (
                                        reactant_halogens.get(halogen, 0) + 1
                                    )
                                ...
                                if checker.check_fg(
                                    f"Alkenyl {halogen.lower()}ide", reactant
                                ):
                                    reactant_halogens[halogen] = (
                                        reactant_halogens.get(halogen, 0) + 1
                                    )
                                ...
                                # Check haloalkynes
                                if halogen == "I" and checker.check_fg(
                                    "Haloalkyne", reactant
                                ):
                                    reactant_halogens[halogen] = (
                                        reactant_halogens.get(halogen, 0) + 1
                                    )
                                elif halogen == "Br" and checker.check_fg(
                                    "Haloalkyne", reactant
                                ):
                                    reactant_halogens[halogen] = (
                                        reactant_halogens.get(halogen, 0) + 1
                                    )
                                elif halogen == "Cl" and checker.check_fg(
                                    "Haloalkyne", reactant
                                ):
                                    reactant_halogens[halogen] = (
                                        reactant_halogens.get(halogen, 0) + 1
                                    )
                                elif halogen == "F" and checker.check_fg(
                                    "Haloalkyne", reactant
                                ):
                                    reactant_halogens[halogen] = (
                                        reactant_halogens.get(halogen, 0) + 1
                ...
                try:
                    ...
                    for halogen in ["I", "Br", "Cl", "F"]:
                        ...
                        if checker.check_fg(f"Primary {halogen.lower()}ide", product):
                            product_halogens[halogen] = (
                                product_halogens.get(halogen, 0) + 1
                            )
    ...
    if len(removals) > 0:
        print(
            f"Halogen exchange strategy detected with {len(removals)} halogen removals"
        )
        return True
