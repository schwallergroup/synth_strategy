...
def main(route):
        ...
        if node["type"] == "mol":
            ...
            if node["smiles"]:
                ...
                # Another common pyrazole pattern
                    ...
                    has_pyrazole = True
                    print(
                        f"Pyrazole scaffold detected via alternate pattern in: {mol_smiles}"
                    )
            ...
            if "metadata" in node and "rsmi" in node["metadata"]:
                ...
                if is_snar:
                    ...
                    if depth <= 1 and checker.check_fg("Ether", product):
                        ...
                        print(
                            f"Late-stage ether formation detected at depth {depth}: {product}"
                        )
    ...
    strategy_present = (
        has_pyrazole and snAr_reactions >= 2 and late_stage_ether_formation
    )
