...
def main(route):
        ...
        if node["type"] == "reaction":
            if "rsmi" in node.get("metadata", {}):
                ...
                if (
                    ...
                    nitration_depth = depth
                    print(
                        f"Detected nitration (by FG) at depth {depth}, product: {product}"
                    )
                ...
                if (
                    ...
                    if product_mol and product_mol.HasSubstructMatch(
                        ...
                        chlorination_depth = depth
                        print(
                            f"Detected chlorination (by FG) at depth {depth}, product: {product}"
                        )
                ...
                if substitution_depth == -1:
                    ...
                    if all(reactant_mols) and product_mol:
                        ...
                        has_cl_product = product_mol.HasSubstructMatch(
                            Chem.MolFromSmarts("c-Cl")
                        )
                        has_nh_product = product_mol.HasSubstructMatch(
    ...
    if nitration_depth != -1 and chlorination_depth != -1 and substitution_depth != -1:
        ...
        if nitration_depth > chlorination_depth > substitution_depth:
            print(
                "Detected early nitration with nucleophilic aromatic substitution strategy"
            )
            return True
