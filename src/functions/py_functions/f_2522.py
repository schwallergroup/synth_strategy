...
def main(route):
    ...
    fg_transformations = [
        ...
        (
            "Boronic ester",
            "Boronic acid",
            "Preparation of boronic acids from boronic ether",
        ),
        (
            "Carboxylic acid",
            "Alcohol",
        ...
        if (
            ...
            for reactant_fg, product_fg, reaction_type in fg_transformations:
                ...
                # Special case for aldehyde to oxime transformation
                    ...
                    reactant_has_aldehyde = any(
                        checker.check_fg("Aldehyde", r) for r in reactants
                    )
                    product_has_oxime = any(
                        checker.check_fg("Oxime", p) for p in products
                    )
                ...
                # Special case for carboxylic acid to alcohol reduction
                    ...
                    product_has_alcohol = any(
                        checker.check_fg("Alcohol", p) for p in products
                    )
