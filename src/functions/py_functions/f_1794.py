    ...
    def dfs_traverse(node, depth=0):
        ...
        if (
            ...
            if depth <= 1:
                ...
                has_tertiary_alcohol_in_product = checker.check_fg(
                    "Tertiary alcohol", product
                )
                print(
                    f"Has tertiary alcohol in product: {has_tertiary_alcohol_in_product}"
                )
                ...
                if (
                    ...
                    and (
                        ...
                        or is_organolithium_reaction
                        or "Li" in rsmi
                    )
                ):
                    print(
                        f"Found late-stage tertiary alcohol formation via addition to ketone"
                    )
