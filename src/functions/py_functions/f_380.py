        ...
        if (
            ...
            if "rsmi" in node.get("metadata", {}):
                ...
                has_formaldehyde = any(
                    checker.check_fg("Formaldehyde", r) for r in reactants if r
                )
                ...
                product_has_secondary_amine = checker.check_fg(
                ...
                print(
                    f"  Is reductive amination with aldehyde: {is_reductive_amination_aldehyde}"
                )
                print(
                    f"  Is reductive amination with ketone: {is_reductive_amination_ketone}"
                )
                print(
                    f"  Is reductive amination with alcohol: {is_reductive_amination_alcohol}"
                )
                print(
