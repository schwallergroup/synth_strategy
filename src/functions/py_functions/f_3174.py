...
def main(route):
                            ...
                            if "C" in neighbors and "O" in neighbors:
                                ...
                                for c in carbon_neighbors:
                                    if any(
                                        ...
                                        print(
                                            f"Confirmed Weinreb amide in molecule: {mol_smiles}"
                                        )
                                        break
    ...
    # If we didn't find an amide coupling reaction but the target has an amide, consider it late-stage
        ...
        print(
            "No explicit amide coupling reaction found, but target molecule contains amide group"
        )
        has_late_amide_coupling = True

    # Check if all three strategy components are present
    combined_strategy = (
        has_cyclopropane and has_weinreb_amide and has_late_amide_coupling
    )
