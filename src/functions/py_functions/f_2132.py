...
def main(route):
    ...
    if route["type"] == "mol":
        final_product_has_cyclopropane = checker.check_ring(
            "cyclopropane", route["smiles"]
        )
        ...
        if node["type"] == "mol":
            ...
            try:
                ...
                if product_has_cyclopropane and not reactant_has_cyclopropane:
                    print(
                        f"Cyclopropane formed in reaction at depth {depth} (forward direction)"
                    )
                ...
                # If product doesn't have cyclopropane but a reactant does, it's broken in this step (forward)
                    ...
                    print(
                        f"Cyclopropane broken in reaction at depth {depth} (forward direction)"
                    )
