...
def main(route):
        ...
        try:
            ...
            if (
                ...
                if added_fgs or removed_fgs:
                    print(
                        f"Functional group changes: Added {added_fgs}, Removed {removed_fgs}"
                    )
        ...
        if node["type"] == "mol":
            ...
            try:
                ...
                if checker.check_ring(
                    heterocycle_type, reactants
                ) and checker.check_ring(heterocycle_type, product):
    ...
    print(
        f"Heterocycle sequential functionalization strategy detected: {strategy_present}"
    )
