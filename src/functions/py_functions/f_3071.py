...
def main(route):
            ...
            if "rsmi" in node.get("metadata", {}):
                ...
                if depth >= 2:  # More flexible depth threshold
                    ...
                    is_formylation = (
                        ...
                        or checker.check_reaction(
                            "Oxidation of primary alcohol to aldehyde", rsmi
                        )
                        or checker.check_reaction(
                ...
                is_formyl_manipulation = (
                    ...
                    or checker.check_reaction(
                        "Derived alcohol via homologation of aldehydes with formaldehyde",
                        rsmi,
                    )
                    or checker.check_reaction(
    ...
    if found_formyl_introduction:
        print(
            f"Found {len(formyl_introduction_reactions)} formyl introduction reactions"
        )
    if found_formyl_manipulation:
        print(
            f"Found {len(formyl_manipulation_reactions)} formyl manipulation reactions"
        )
