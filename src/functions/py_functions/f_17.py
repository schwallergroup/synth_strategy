        ...
        if node["type"] == "reaction" and depth == first_reaction_depth:
            ...
            try:
                ...
                if checker.check_reaction("Esterification of Carboxylic Acids", rsmi):
                    ...
                    print(
                        "Detected 'Ester saponification (methyl deprotection)' reaction"
                    )
                    final_step_is_esterification_or_saponification = True
                elif checker.check_reaction(
                    ...
                    print(
                        "Detected 'Ester saponification (alkyl deprotection)' reaction"
                    )
                    final_step_is_esterification_or_saponification = True
                elif checker.check_reaction(
                    ...
                    has_carboxylic_acid_in_product = checker.check_fg(
                        "Carboxylic acid", product
                    )
