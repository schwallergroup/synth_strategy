...
def main(route):
    ...
    transformations = sum(
        [acid_to_ester, ester_to_alcohol, alcohol_to_aldehyde, aldehyde_to_oxime]
    )
    ...
    print(
        f"Found {oxidation_states} oxidation states and {transformations} transformations"
    )
