        ...
        if node["type"] == "mol":
            ...
            if checker.check_ring("piperazine", mol_smiles):
                ...
                if checker.check_fg("Boc", mol_smiles):
                    ...
                    print(
                        f"Found Boc protection on piperazine in molecule: {mol_smiles}"
                    )
                ...
                if "C(=O)OCc1ccccc" in mol_smiles:
                    ...
                    protected_molecules.append(mol_smiles)
                    print(
                        f"Found Cbz protection on piperazine in molecule: {mol_smiles}"
                    )
            ...
            if "rsmi" in node["metadata"]:
                ...
                if reactant_has_piperazine and product_has_piperazine:
                    ...
                    # Check for Cbz deprotection
                        ...
                        "Hydroxyl benzyl deprotection", rxn_smiles
                    ):
                        deprotection_depth = depth
                        deprotected_molecules.append(product)
                    ...
                    # If a protected molecule loses a protecting group
                        ...
                        "C(=O)OCc1ccccc" in r and "C(=O)OCc1ccccc" not in product
                        for r in reactants
                    ) or any(
                        checker.check_fg("Boc", r)
                        and not checker.check_fg("Boc", product)
                        for r in reactants
                    ):
                        deprotection_depth = depth
                        deprotected_molecules.append(product)
                        print(
                            f"Found general deprotection of piperazine at depth {depth}"
                        )
