...
def main(route):
    ...
    def dfs_traverse(node, depth=0):
        if node["type"] == "reaction":
            ...
            is_friedel_crafts_acylation = checker.check_reaction(
                "Friedel-Crafts acylation", rsmi
            )
            is_friedel_crafts_alkylation = checker.check_reaction(
                "Friedel-Crafts alkylation", rsmi
            )
            ...
            if not is_friedel_crafts:
                ...
                try:
                    ...
                    reagents_part = (
                        rsmi.split(">")[1] if len(rsmi.split(">")) > 2 else ""
                    )
                    ...
                    if (
                        ...
                        print(
                            f"Detected Friedel-Crafts acylation pattern at depth {depth}"
                        )
                    ...
                    # Detect Friedel-Crafts alkylation
                        ...
                        is_friedel_crafts = True
                        print(
                            f"Detected Friedel-Crafts alkylation pattern at depth {depth}"
                        )
