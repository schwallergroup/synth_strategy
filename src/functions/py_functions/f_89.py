...
def main(route):
            ...
            try:
                ...
                for reaction_type in amide_reaction_types:
                    if checker.check_reaction(reaction_type, rsmi):
                        print(
                            f"Found amide formation reaction: {reaction_type} at depth {depth}"
                        )
                ...
                if not is_amide_formation:
                    ...
                    if reactant_has_acid and product_has_amide:
                        print(
                            f"Found carboxylic acid to amide transformation at depth {depth}"
                        )
                        is_amide_formation = True
    ...
    is_late_stage = (
        amide_formation_depth is not None and amide_formation_depth <= max_depth / 3
    )
