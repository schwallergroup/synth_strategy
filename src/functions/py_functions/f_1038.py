    ...
    def dfs_traverse(node, depth=0):
        ...
        if (
            ...
            if len(reactants_smiles) >= 2:
                ...
                complex_fragments = [
                    mol for mol in reactants if mol and mol.GetNumAtoms() >= 10
                ]
                ...
                if len(complex_fragments) >= 2:
                    ...
                    if is_coupling_reaction:
                        print(
                            f"Found late-stage coupling of complex fragments at depth {depth}"
                        )
                        ...
                        if product and all(
                            product.GetNumAtoms() > mol.GetNumAtoms()
