                    ...
                    if ">" in rsmi:
                        ...
                        for ring in c_n_heterocycles:
                            if not checker.check_ring(
                                ring, reactants
                            ) and checker.check_ring(ring, product):
                                c_n_bond_formations += 1
                                print(
                                    f"C-N bond formation detected: Formation of {ring} ring"
                                )
                        ...
                        if not product_has_new_heterocycle:
                            ...
                            # Check for reductive amination (general case)
                                ...
                                c_n_bond_formations += 1
                                print(
                                    f"C-N bond formation detected: Reductive amination (general)"
                                )
                            ...
                            # Check for amide formation (general case)
                                ...
                                c_n_bond_formations += 1
                                print(
                                    f"C-N bond formation detected: Amide formation (general)"
                                )
                            ...
                            # Check for urea formation (general case)
                                ...
                                c_n_bond_formations += 1
                                print(
                                    f"C-N bond formation detected: Urea formation (general)"
                                )
                            ...
                            # Check for imine formation (general case)
                                ...
                                c_n_bond_formations += 1
                                print(
                                    f"C-N bond formation detected: Imine formation (general)"
                                )
                            ...
                            # Check for aza-Michael addition (general case)
                                ...
                                for fg in ["Vinyl", "Allyl", "Conjugated diene"]:
                                    if checker.check_fg(
                                        fg, reactants
                                    ) and not checker.check_fg(fg, product):
                                        c_n_bond_formations += 1
                                        print(
                            ...
                            # Check for azide to amine conversion (often involves C-N bond formation)
                                ...
                                c_n_bond_formations += 1
                                print(
                                    f"C-N bond formation detected: Azide to amine conversion"
                                )
                            ...
                            # Check for nitro to amine reduction (can lead to C-N bond formation)
                                ...
                                c_n_bond_formations += 1
                                print(
                                    f"C-N bond formation detected: Nitro to amine reduction"
                                )
