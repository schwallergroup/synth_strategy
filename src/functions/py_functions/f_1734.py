...
def main(route):
    ...
    if route["type"] == "mol":
        ...
        target_has_trifluoromethyl = checker.check_fg(
            "Trifluoro group", target_mol_smiles
        )
    ...
    def check_reaction_preservation(node):
        ...
        if (
            ...
            product_has_trifluoromethyl = checker.check_fg(
    ...
    if preservation:
        print(
            "Both nitrile and trifluoromethyl groups are preserved throughout the synthesis"
        )
