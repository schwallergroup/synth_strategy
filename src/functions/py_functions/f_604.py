    ...
    def dfs_traverse(node, depth=0):
        ...
        if (
            ...
            if not is_amide_formation:
                ...
                print(
                    f"Amines - Primary: {has_primary_amine}, Secondary: {has_secondary_amine}"
                )
                ...
                if (
                    ...
                    try:
                        ...
                        if amine_reactant and acyl_reactant:
                            ...
                            is_amide_formation = True
                            print(
                                f"Detected amide formation by functional group analysis"
                            )
                        ...
                        is_amide_formation = True
                        print(
                            f"Detected amide formation by functional group analysis (fallback)"
                        )
