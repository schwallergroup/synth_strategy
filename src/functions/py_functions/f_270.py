...
def main(route):
    ...
    def dfs_traverse(node):
        ...
        # Check reaction nodes for protection/deprotection reactions
            ...
            if (
                ...
                or checker.check_reaction(
                    "Hydrogenolysis of amides/imides/carbamates", rxn_smiles
                )
            ):
    ...
    print(
        f"Boc protection: {has_boc_protection}, Boc deprotection: {has_boc_deprotection}"
    )
    print(
        f"Cbz protection: {has_cbz_protection}, Cbz deprotection: {has_cbz_deprotection}"
    )
