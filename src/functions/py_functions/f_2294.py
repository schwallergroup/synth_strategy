    ...
    def is_knoevenagel_reaction(rsmi):
        ...
        try:
            ...
            for reactant in reactants:
                ...
                if checker.check_fg("Nitrile", reactant):
                    ...
                    if "CH2" in reactant or "[CH2" in reactant:
                        has_active_methylene = True
                        print(
                            f"Found nitrile-containing active methylene compound: {reactant}"
                        )
            ...
            if product_mol and (
                ...
                print(
                    f"Product has characteristics of Knoevenagel product: {products_part}"
                )
                ...
                if has_carbonyl and has_active_methylene:
                    print(
                        "Identified as Knoevenagel condensation based on reactants and product"
                    )
                    return True
        ...
        if node["type"] == "reaction":
            if "rsmi" in node.get("metadata", {}):
                ...
                if checker.check_reaction("Knoevenagel Condensation", rsmi):
                    ...
                    print(
                        f"Knoevenagel condensation detected at depth {depth} by checker"
                    )
