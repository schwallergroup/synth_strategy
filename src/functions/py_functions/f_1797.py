    ...
    def dfs_traverse(node, depth=0):
        ...
        if (
            ...
            if depth <= max_depth_to_check:
                ...
                if len(reactants) >= 2:
                    print(
                        f"Found convergent reaction with {len(reactants)} reactants",
                        flush=True,
                    )
                    ...
                    if is_coupling:
                        ...
                        if has_heterocycle and has_complex_ring:
                            ...
                            print(
                                f"Heterocycle reactant: {heterocycle_reactant}",
                                flush=True,
                            )
                            print(
                                f"Complex ring reactant: {complex_ring_reactant}",
                                flush=True,
                            )
