            ...
            try:
                ...
                for rxn_type in halogen_reactions:
                    if checker.check_reaction(rxn_type, rsmi):
                        ...
                        if (
                            "fluorination" in rxn_type.lower()
                            or rxn_type == "Fluorination"
                        ):
                            halogen_preservation["F"] = False
                            print("F preservation set to False")
                        elif (
                            "chlorination" in rxn_type.lower()
                            or rxn_type == "Chlorination"
                        ):
                            halogen_preservation["Cl"] = False
                            print("Cl preservation set to False")
                        elif (
                            "bromination" in rxn_type.lower()
                            or rxn_type == "Bromination"
                        ):
                            halogen_preservation["Br"] = False
                            print("Br preservation set to False")
                        elif (
                            "iodination" in rxn_type.lower() or rxn_type == "Iodination"
                        ):
                            ...
                            for halogen in ["F", "Cl", "Br", "I"]:
                                ...
                                print(
                                    f"{halogen} preservation set to False due to dehalogenation"
                                )
                            ...
                            for halogen in ["F", "Cl", "Br", "I"]:
                                halogen_preservation[halogen] = False
                                print(
                                    f"{halogen} preservation set to False due to Finkelstein"
                                )
                        elif rxn_type == "Aromatic substitution of bromine by chlorine":
                            halogen_preservation["Br"] = False
                            halogen_preservation["Cl"] = False
                            print(
                                "Br and Cl preservation set to False due to substitution"
                            )
