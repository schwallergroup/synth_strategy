                ...
                if "rsmi" in node.get("metadata", {}):
                    ...
                    if ketone_in_reactants and oxime_in_product:
                        ...
                        for r in reactants:
                            try:
                                ...
                                # Check for hydroxylamine pattern in atom-mapped SMILES
                                    ...
                                    hydroxylamine_present = True
                                    print(
                                        f"Found atom-mapped hydroxylamine reagent: {r}"
                                    )
                                    break
                            except Exception as e:
                                print(
                                    f"Error checking hydroxylamine in reactant {r}: {e}"
                                )
                        ...
                        if hydroxylamine_present:
                            ...
                            print(
                                "Confirmed ketone to oxime transformation with hydroxylamine"
                            )
                        else:
                            ...
                            for r in reactants:
                                if "NH2" in r and "OH" in r:
                                    print(
                                        f"Found potential hydroxylamine pattern in: {r}"
                                    )
                                    oxime_formation_found = True
                                    print(
