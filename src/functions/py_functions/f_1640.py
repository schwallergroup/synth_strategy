        ...
        if node["type"] == "reaction" and node.get("metadata", {}).get("rsmi"):
                ...
                for reactant in reactants:
                    if (
                        ...
                        for r in reactants:
                            if is_benzyl_halide(r):
                                print(
                                    f"Detected benzyl protection via N-alkylation: {rsmi}"
                                )
                                has_benzyl_protection = True
                    ...
                    if checker.check_fg("Carboxylic acid", reactant):
                        ...
                        for r in reactants:
                            if is_benzyl_alcohol(r):
                                print(
                                    f"Detected benzyl protection via esterification: {rsmi}"
                                )
                                has_benzyl_protection = True
                    ...
                    if checker.check_fg("Aromatic thiol", reactant) or checker.check_fg(
                        ...
                        for r in reactants:
                            if is_benzyl_halide(r) or is_benzyl_alcohol(r):
                                print(
                                    f"Detected benzyl protection via S-alkylation: {rsmi}"
                                )
                                has_benzyl_protection = True
            ...
            for reactant in reactants:
                ...
                if checker.check_fg("Aromatic thiol", reactant) or checker.check_fg(
                    ...
                    if has_benzyl_thioether(product) and not has_benzyl_thioether(
                        reactant
                    ):
            ...
            benzyl_in_product = (
                Chem.MolFromSmiles(product).HasSubstructMatch(
                    Chem.MolFromSmarts("c1ccccc1C")
                )
