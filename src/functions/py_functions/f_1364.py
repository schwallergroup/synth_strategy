        ...
        if node["type"] == "reaction":
            if "metadata" in node and "rsmi" in node["metadata"]:
                ...
                if product_mol:
                    ...
                    product_amide_matches = len(
                        product_mol.GetSubstructMatches(amide_pattern)
                    )
                    product_urea_matches = len(
                        product_mol.GetSubstructMatches(urea_pattern)
                    )
                    ...
                    if (
                        ...
                        print(
                            f"Detected C-N bond formation, total count: {cn_bond_formations}"
                        )
