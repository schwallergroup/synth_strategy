    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "mol" and "smiles" in node:
            ...
            if depth == 0:
                ...
                print(
                    f"Target molecule has trifluoromethoxy: {target_has_trifluoromethoxy}"
                )
            ...
            try:
                ...
                product_has_trifluoromethoxy = checker.check_fg(
                ...
                if product_has_trifluoromethoxy and not reactants_have_trifluoromethoxy:
                    ...
                    reactants_have_trifluoromethoxy and not product_has_trifluoromethoxy
                ):
