                ...
                if not (protection_reactions or deprotection_reactions):
                    ...
                    if product_mol_smiles:
                        ...
                        if (
                            ...
                            and not any(
                                checker.check_fg("Boc", r) for r in reactant_mols_smiles
                            )
                            and any(
                            ...
                            protection_reactions.append((rsmi, depth))
                            print(
                                f"Boc protection detected (fallback) at depth {depth}: {rsmi}"
                            )
                    ...
                    if product_mol_smiles:
                        ...
                        if (
                            ...
                            and (
                                ...
                                or checker.check_fg(
                                    "Secondary amine", product_mol_smiles
                                )
                            )
                        ):
                            deprotection_reactions.append((rsmi, depth))
                            print(
                                f"Boc deprotection detected (fallback) at depth {depth}: {rsmi}"
                            )
