    ...
    def dfs_traverse(node, depth=0):
        ...
        # For reaction nodes, check if the reaction involves halogen transformation
            ...
            halogen_reaction = (
                ...
                or checker.check_reaction(
                    "Halodeboronation of boronic acids", rxn_smiles
                )
                or checker.check_reaction(
                    "Halodeboronation of boronic esters", rxn_smiles
                )
            )
            ...
            if halogen_reaction:
                ...
                print(
                    f"Found halogen-involving reaction at depth {depth}: {rxn_smiles}"
                )
