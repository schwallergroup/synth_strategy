...
def main(route):
    ...
    deprotection_events = (
        []
    )  # List of (depth, reactant_smiles, protecting_group) tuples
    modification_events = (
        []
    ...
    def identify_protecting_group(rsmi):
        ...
        if any(
            checker.check_reaction(rxn, rsmi) for rxn in protection_reactions[:6]
        ) or any(
                ...
                for rxn in protection_reactions:
                    if checker.check_reaction(rxn, rsmi):
                        ...
                        if protecting_group:
                            ...
                            print(
                                f"Found {protecting_group} protection at depth {depth}"
                            )
                            is_protection = True
                            break
                    ...
                    for reactant in reactants:
                        if has_protecting_group(reactant):
                            ...
                            modification_events.append(
                                (depth, reactant, product, protecting_group)
                            )
                            print(
