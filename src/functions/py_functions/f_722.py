...
def main(route):
            ...
            for heterocycle in heterocycles:
                if checker.check_ring(heterocycle, product_smiles):
                    ...
                    if not reactants_have_heterocycle:
                        ...
                        if (
                            heterocycle == "pyrazole"
                            and not reaction_is_heterocycle_formation
                        ):
                            ...
                            if has_hydrazine and has_nitrile:
                                print(
                                    "Detected pyrazole formation from hydrazine and nitrile"
                                )
                                reaction_is_heterocycle_formation = True

                        if reaction_is_heterocycle_formation:
                            print(
                                f"{formed_heterocycle} ring formation detected at depth {depth}"
                            )
    ...
    is_late_stage = (
        heterocycle_formation_found and heterocycle_formation_depth < halfway_depth
    )
