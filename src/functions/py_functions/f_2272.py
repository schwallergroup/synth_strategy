...
def main(route):
        ...
        if node["type"] == "mol":
            ...
            # Fallback method if specific reaction checks fail
                ...
                if reactants_have_precursor and product_has_azide:
                    azide_forming_reactions += 1
                    print(
                        f"Azide formation detected through functional group analysis: {rsmi}"
                    )
                ...
                if reactants_have_azide and product_lacks_azide:
                    azide_utilizing_reactions += 1
                    print(
                        f"Azide utilization detected through functional group analysis: {rsmi}"
                    )
    ...
    print(
        f"Azide-based functional group manipulation strategy detected: {azide_strategy_present}"
    )
