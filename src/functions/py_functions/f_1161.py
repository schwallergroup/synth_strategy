...
def main(route):
    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "mol":
            ...
            if mol and mol.HasSubstructMatch(benzimidazole_pattern):
                ...
                if (
                    benzimidazole_formation_depth is None
                    or depth < benzimidazole_formation_depth
                ):
    ...
    is_late_stage = (
        benzimidazole_formation_depth is not None and benzimidazole_formation_depth <= 1
    )
