        ...
        if node["type"] == "mol":
            ...
            for heterocycle in product_heterocycles:
                ...
                if not reactant_has_heterocycle:
                    print(
                        f"Found {heterocycle} formation reaction at depth {depth}: {rsmi}"
                    )

                    # Check specific formation reactions based on the heterocycle
                    if heterocycle == "benzothiazole":
                        if checker.check_reaction(
                            "benzothiazole formation from aldehyde", rsmi
                        ):
                            print(
                                f"Identified as benzothiazole formation from aldehyde"
                            )
                        elif checker.check_reaction(
                            "benzothiazole formation from acyl halide", rsmi
                        ):
                            print(
                                f"Identified as benzothiazole formation from acyl halide"
                            )
                        elif checker.check_reaction(
                        ...
                        if checker.check_reaction(
                            "benzoxazole formation from aldehyde", rsmi
                        ):
                            ...
                            print(
                                f"Identified as benzoxazole formation from acyl halide"
                            )
                        elif checker.check_reaction(
                            "benzoxazole formation from ester/carboxylic acid", rsmi
                        ):
                            print(
                                f"Identified as benzoxazole formation from ester/carboxylic acid"
                            )
                        elif checker.check_reaction(
                            "benzoxazole formation (intramolecular)", rsmi
                        ):
                            print(
                                f"Identified as benzoxazole formation (intramolecular)"
                            )
                        elif checker.check_reaction(
                            "{benzoxazole_arom-aldehyde}", rsmi
                        ):
                            print(
                                f"Identified as benzoxazole formation from aromatic aldehyde"
                            )
                        elif checker.check_reaction(
                            "{benzoxazole_carboxylic-acid}", rsmi
                        ):
                            print(
                                f"Identified as benzoxazole formation from carboxylic acid"
                            )
                        ...
                        if checker.check_reaction(
                            ...
                            print(
                                f"Identified as benzimidazole formation from aldehyde"
                            )
                        elif checker.check_reaction(
                            "benzimidazole formation from acyl halide", rsmi
                        ):
                            print(
                                f"Identified as benzimidazole formation from acyl halide"
                            )
                        elif checker.check_reaction(
