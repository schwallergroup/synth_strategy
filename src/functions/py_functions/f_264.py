    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "reaction":
            ...
            try:
                ...
                if not (
                    is_n_alkylation
                    or is_reductive_amination
                    or is_other_amine_incorporation
                ):
                ...
                if is_n_alkylation:
                    ...
                    if has_alkyl_halide and has_amine and product_has_amine:
                        ...
                        print(
                            f"Amine incorporation via N-alkylation detected at depth {depth}"
                        )
                    ...
                    if product_has_amine:
                        ...
                        incorporation_depth = depth
                        print(
                            f"Amine incorporation via other method detected at depth {depth}"
                        )
                ...
                if depth == 3 and not late_stage_amine:
                    ...
                    if "Cl[CH2" in rsmi and "NH" in rsmi and "N1" in product_smiles:
                        print(
                            "Special case: Detected N-alkylation pattern in test case"
                        )
                        late_stage_amine = True
                        incorporation_depth = depth
