...
def main(route):
                ...
                if checker.check_ring("thiazole", product):
                    ...
                    for reactant in reactants:
                        if checker.check_ring(
                            ...
                            print(
                                f"Found thiazole modification (dechlorination) at depth {depth}"
                            )
    ...
    if has_sequential_reductive_amination and (
        has_boc_protection or has_thiazole_modification
    ):
        print(
            "Detected combined reductive amination strategy with protection/modification"
        )
        return True
