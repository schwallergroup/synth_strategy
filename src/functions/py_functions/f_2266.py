                ...
                if checker.check_ring("piperazine", product):
                    ...
                    if piperazine_reactant and other_reactants:
                        ...
                        if is_alkylation or methyl_iodide_present:
                            print(
                                f"Confirmed N-alkylation/methylation reaction: {rsmi}"
                            )
                            ...
                            for other_r in other_reactants:
                                if (
                                    ...
                                    print(
                                        f"Found reactant with leaving group: {other_r}"
                                    )
                                    has_leaving_group = True

                                    # Check if both fragments are complex
                                    piperazine_mol = Chem.MolFromSmiles(
                                        piperazine_reactant
                                    )
                                    ...
                                    if piperazine_mol and other_mol:
                                        ...
                                        print(
                                            "Could not create RDKit molecules from SMILES"
                                        )
                            ...
                            if piperazine_mol:
                                ...
                                if has_nh:
                                    ...
                                    for other_r in other_reactants:
                                        if (
                                            checker.check_fg("Primary halide", other_r)
                                            or checker.check_fg(
                                                "Secondary halide", other_r
                                            )
                                            or checker.check_fg(
                                                "Tertiary halide", other_r
                                            )
                                            or checker.check_fg("Mesylate", other_r)
                                            or checker.check_fg("Tosylate", other_r)
                                            or checker.check_fg("Triflate", other_r)
                                ...
                                print(
                                    "Not an N-alkylation reaction and fallback check failed"
                                )
                    else:
                        print(
                            "Did not find both piperazine reactant and other reactants"
                        )
                else:
