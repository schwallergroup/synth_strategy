            ...
            if "rsmi" in node.get("metadata", {}):
                ...
                if product_has_thiazole:
                    ...
                    if not thiazole_in_reactants:
                        print(
                            f"Potential thiazole formation detected in reaction: {rsmi}"
                        )
                        ...
                        for reactant in reactants_smiles:
                            if (
                                ...
                                print(
                                    f"Reactant contains thiazole-related ring: {reactant}"
                                )
                                break
                        ...
                        if acyclic_precursors:
                            ...
                            if (
                                ...
                                if has_thiol_or_thioamide and (
                                    has_amino_or_amide or has_carbonyl
                                ):
                                    print(
