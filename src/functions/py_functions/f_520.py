            ...
            for reactant in reactants_smiles:
                ...
                if has_cyclic_reactant:
                    ...
                    if (
                        ...
                        print(
                            f"Found ketal/acetal ring opening based on functional groups: {rsmi}"
                        )
                        has_ring_opening = True
                        return

                    if (
                        checker.check_ring("oxirane", reactant)
                        and "OH" in product_smiles
                    ):
                        print(
                            f"Found epoxide ring opening based on functional groups: {rsmi}"
                        )
                        has_ring_opening = True
                        return
