...
def main(route):
    ...
    def dfs_traverse(node):
        ...
        if node["type"] == "reaction":
            ...
            if not has_lactam_formation:
                ...
                lactam_formed = checker.check_ring(
                    "pyrrolidone", product_smiles
                ) and not any(
                ...
                if not lactam_formed:
                    ...
                    if (
                        ...
                        and not any(
                            r and r.HasSubstructMatch(lactam_pattern)
            ...
            if not has_morpholine_formation:
                ...
                elif "O1CCN" in product_smiles and not any(
                    "O1CCN" in r for r in reactants_smiles
                ):
                ...
                # Check if the reaction creates a morpholine-like structure (O-C-C-N in a ring)
                    ...
                    if (
                        ...
                        and not any(
                            r and r.HasSubstructMatch(morpholine_pattern)
                            for r in reactant_mols
                        )
                    ):
    ...
    features_count = sum(
        [
            has_lactam_formation,
            has_morpholine_formation,
            has_epoxide_opening,
            has_nitro_reduction,
        ]
    )
