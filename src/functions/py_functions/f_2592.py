...
def main(route):
    ...
    def dfs_traverse(node, depth=0):
        ...
        if (
            ...
            if not is_reductive_amination:
                ...
                if has_carbonyl and has_amine:
                    ...
                    if (
                        ...
                        print(
                            f"Found potential reductive amination at depth {depth}: {rsmi}"
                        )
            ...
            if depth <= 1 and is_reductive_amination:
                ...
                print(
                    f"Detected late-stage reductive amination at depth {depth}: {rsmi}"
                )
    ...
    print(
        f"Late-stage reductive amination strategy detected: {found_reductive_amination}"
    )
