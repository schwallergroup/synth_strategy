                    ...
                    for reactant in reactants:
                        for amine in cyclic_amines:
                            if checker.check_ring(amine, reactant):
                                ...
                                other_reactants = [
                                    r for r in reactants if r != reactant
                                ]
                                other_reactants_have_amine = any(
                                    checker.check_ring(amine, r)
                                    for r in other_reactants
                                )

                                if (
                                    not other_reactants_have_amine
                                    and checker.check_ring(amine, product_str)
                                ):
                                    ...
                                    is_coupling = (
                                        ...
                                        or checker.check_reaction(
                                            "Buchwald-Hartwig", rsmi
                                        )
                                        or checker.check_reaction(
                                            "N-arylation_heterocycles", rsmi
                                        )
                                        or checker.check_reaction(
                                            "Ullmann-Goldberg Substitution amine", rsmi
                                        )
                                        or checker.check_reaction(
                                            "Goldberg coupling", rsmi
                                        )
                                        or checker.check_reaction(
                                            "heteroaromatic_nuc_sub", rsmi
                                        )
                                        or checker.check_reaction(
