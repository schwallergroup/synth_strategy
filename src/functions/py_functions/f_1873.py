                ...
                if not is_nucleophilic_sub:
                    ...
                    if halide_reactant and nitrogen_reactant:
                        ...
                        if not has_halide_in_product:
                            is_nucleophilic_sub = True
                            print(
                                "Found nucleophilic substitution pattern (halide replacement)"
                            )
                        ...
                        if has_halide:
                            ...
                            if mol:
                                ...
                                benzylic_pattern = Chem.MolFromSmarts(
                                    "c[CD1,CD2,CD3][F,Cl,Br,I]"
                                )
                                if mol.HasSubstructMatch(benzylic_pattern):
                                    print(
                                        f"Found potential benzylic halide: {reactant}"
                                    )
                                    ...
                                    for ring in heterocycles:
                                        if checker.check_ring(ring, reactant):
                                            ...
                                            print(
                                                f"Found heterocycle ({ring}) in benzylic halide"
                                            )
                                            break
                    ...
                    if benzylic_halide_reactant and nitrogen_nucleophile_reactant:
                        ...
                        if product_mol:
                            ...
                            if heterocycle_in_product and not halide_in_product:
                                ...
                                print(
                                    "Confirmed benzylic halide coupling transformation"
                                )
                                ...
                                print(
                                    "Product structure doesn't match expected transformation"
                                )
