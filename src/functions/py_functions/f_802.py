...
def main(route):
        ...
        if node["type"] == "reaction":
            if "rsmi" in node.get("metadata", {}):
                ...
                if (
                    ...
                    for r in reactants:
                        if r:  # Skip empty strings
                            ...
                            if ester_indices:
                                ...
                                print(
                                    f"Found {num_esters} ester groups in reactant: {r}"
                                )
                    ...
                    print(
                        f"Found {carboxylic_acid_count} carboxylic acid groups in product"
                    )
                    ...
                    if ester_present and carboxylic_acid_in_product:
                        ...
                        carboxylic_acid_count = (
                            len(carboxylic_acid_indices)
                            if carboxylic_acid_indices
                            else 0
                        )
                        print(
                            f"Found {carboxylic_acid_count} carboxylic acid groups in product"
    ...
    print(
        f"Total ester hydrolysis steps found: {ester_hydrolysis_count}, returning: {result}"
    )
    return result
