...
def main(route):
        ...
        if node["type"] == "reaction":
            ...
            if all(reactant_mols) and product_mol:
                ...
                if any(
                    ...
                    print(
                        f"Detected protection (acid → tert-butyl ester) at depth {depth}"
                    )
                ...
                if any(
                    ...
                    print(
                        f"Detected deprotection (tert-butyl ester → acid) at depth {depth}"
                    )
    ...
    has_protection_deprotection = (
        len(protection_steps) > 0 and len(deprotection_steps) > 0
    )
