                ...
                if is_n_alkylation:
                    ...
                    if amine_fragment and alkylating_fragment:
                        ...
                        if amine_mol and alkyl_mol:
                            ...
                            print(
                                f"Amine fragment complexity: {amine_complexity} heavy atoms"
                            )
                            print(
                                f"Alkylating fragment complexity: {alkyl_complexity} heavy atoms"
                            )
                            ...
                            if amine_complexity >= 6 or alkyl_complexity >= 6:
                                ...
                                if product_mol:
                                    ...
                                    print(
                                        f"Primary amines in product: {primary_count_product}"
                                    )
                                    print(
                                        f"Secondary amines in product: {secondary_count_product}"
                                    )
                                    ...
                                    if (
                                        ...
                                        or (
                                            ...
                                            and secondary_count_product
                                            > secondary_count_amine
                                        )
                                        or secondary_count_product
                                        < secondary_count_amine
                                    ):
                                        print(
                ...
                if not n_alkylation_found:
                    ...
                    if amine_fragment and alkylating_fragment:
                        ...
                        if amine_mol and product_mol and alkyl_mol:
                            ...
                            nh_count_reactant = len(
                                amine_mol.GetSubstructMatches(nh_pattern)
                            )
                            nh_count_product = len(
                                product_mol.GetSubstructMatches(nh_pattern)
                            )

                            print(
                                f"Primary amines in amine fragment: {primary_count_reactant}"
                            )
                            print(
                                f"Secondary amines in amine fragment: {secondary_count_reactant}"
                            )
                            ...
                            if not n_alkylation_found:
                                ...
                                try:
                                    ...
                                    print(
                                        f"MCS size with amine fragment: {amine_mcs_size}"
                                    )
                                    print(
                                        f"MCS size with alkylating fragment: {alkyl_mcs_size}"
                                    )

                                    # If product contains substantial parts of both fragments
                                    if (
                                        amine_mcs_size
                                        >= amine_mol.GetNumHeavyAtoms() * 0.7
                                        and alkyl_mcs_size
                                        >= alkyl_mol.GetNumHeavyAtoms() * 0.7
                                        and (
                                            amine_complexity >= 6
                                            or alkyl_complexity >= 6
                                        )
                                    ):
                                        print(
                                            f"Found fragment coupling based on MCS analysis"
                                        )
                                        n_alkylation_found = True
