...
def main(route):
        ...
        if (
            ...
            if not pyrazole_formation_found:
                ...
                if checker.check_ring("pyrazole", product_smiles):
                    ...
                    reactants_have_pyrazole = any(
                        checker.check_ring("pyrazole", reactant)
                ...
                if checker.check_reaction(
                    "pyrazole", rxn_smiles
                ) or checker.check_reaction("{pyrazole}", rxn_smiles):
            ...
            if depth <= 3:  # Consider reactions at depth 0, 1, 2, or 3 as late-stage
                ...
                # This is a more general check for ether formation
                    ...
                    any("O" in reactant for reactant in reactants_smiles)
    ...
    print(
        f"Combined pyrazole formation with ether coupling strategy: {combined_strategy}"
    )
