    ...
    def dfs_traverse(node, depth=0):
        ...
        if (
            ...
            if product and not has_n_arylation:
                ...
                if any(n_aryl_indicators) and (
                    any(amine_reactants) or any(aryl_halide_reactants)
                ):
                    print(
                        f"  Detected potential N-arylation: N-aryl bond formed in product"
                    )
                    has_n_arylation = True
                ...
                # Check for specific case in the test data: formation of N-aryl bond in heterocycle
                    ...
                    "c1" in product
                    and "N" in product
                    and any(r and "NH2" in r for r in reactants)
                ):
                    print(
