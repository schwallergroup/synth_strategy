...
def main(route):
    ...
    def dfs_traverse(node, depth=0):
        ...
        ):  # Final reaction or one step before
                ...
                if oxidation_reaction:
                    ...
                    for reactant in reactants:
                        if checker.check_fg(
                            ...
                            print(
                                f"Found secondary alcohol in reactant and ketone in product"
                            )
                            found_pattern = True
                            break
                    ...
                    for reactant in reactants:
                        if checker.check_fg("Ketone", reactant) and checker.check_fg(
                            ...
                            print(
                                f"Found ketone in reactant and secondary alcohol in product"
                            )
                            found_pattern = True
                            break
