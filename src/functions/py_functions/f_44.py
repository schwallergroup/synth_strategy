                ...
                for reactant in reactants:
                    ...
                    if checker.check_fg("Phenol", reactant):
                        ...
                        if checker.check_fg("Aromatic halide", product):
                            ...
                            phenol_indices = checker.get_fg_atom_indices(
                                "Phenol", reactant
                            )
                            ...
                            if not oxygen_map_num:
                                ...
                                print(
                                    f"Found oxygen atom with mapping number {oxygen_map_num}"
                                )
                                ...
                                if oxygen_neighbor and oxygen_neighbor.HasProp(
                                    "molAtomMapNumber"
                                ):
                                    carbon_map_num = oxygen_neighbor.GetProp(
                                        "molAtomMapNumber"
                                    )
                                    print(
                                    ...
                                    print(
                                        "Could not find aromatic carbon neighbor of oxygen"
                                    )
