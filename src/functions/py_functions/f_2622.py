...
def main(route):
            ...
            try:
                ...
                if mol is not None:
                    ...
                    if num_stereocenters > 0:
                        ...
                        print(
                            f"Found {num_stereocenters} stereocenters at depth {depth}"
                        )
                    ...
                    if depth == 0 and num_stereocenters > 0:
                        ...
                        print(
                            f"Found {num_stereocenters} stereocenters in final product"
                        )
    ...
    if (
        not has_stereo_in_starting
        and 0 in stereocenters_by_depth
        and 2 in stereocenters_by_depth
    ):
