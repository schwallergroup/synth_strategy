        ...
        if node["type"] == "reaction":
            if "metadata" in node and "rsmi" in node["metadata"]:
                ...
                if checker.check_reaction("Decarboxylation", rsmi):
                    ...
                    print(
                        "Found C-C bond cleavage: Oxidation of alkene to carboxylic acid"
                    )
                    has_cc_cleavage = True
                elif checker.check_reaction(
                    ...
                    print(
                        "Found C-C bond cleavage: Oxidation of ketone to carboxylic acid"
                    )
                    has_cc_cleavage = True
                elif checker.check_reaction(
                ...
                # Check for oxidative cleavage of alcohols
                    ...
                    checker.check_fg("Tertiary alcohol", r) for r in reactants_smiles
                ) and any(checker.check_fg("Ketone", p) for p in product_smiles):
                ...
                # Check for diol cleavage
                    ...
                    and (
                        ...
                        or any(
                            checker.check_fg("Carboxylic acid", p)
                ...
                # Check for alkene cleavage
                    ...
                    or any(
                        checker.check_fg("Carboxylic acid", p) for p in product_smiles
                    )
                ):
