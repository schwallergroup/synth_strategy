...
def main(route):
        ...
        if node["type"] == "reaction":
            ...
            if product_mol:
                ...
                has_biaryl_in_product = any(
                    product_mol.HasSubstructMatch(pattern)
                ...
                if has_biaryl_in_product:
                    ...
                    for r in reactants_smiles:
                        ...
                        if r_mol and any(
                            r_mol.HasSubstructMatch(pattern)
                            for pattern in biaryl_patterns
                        ):
    ...
    print(
        f"  - Biaryl-forming reaction: {has_biaryl_forming_reaction} at depth {biaryl_depth}"
    )
