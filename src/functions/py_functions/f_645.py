...
def main(route):
        ...
        if node["type"] == "reaction":
            if "rsmi" in node.get("metadata", {}):
                ...
                if not cb_formation:
                    ...
                    has_boronic_ester_product = checker.check_fg(
                ...
                if cn2_formation:
                    ...
                    print(
                        f"Second C-N bond formation (amide) detected at depth {depth}"
                    )
    ...
    print(
        f"Found {found_patterns} patterns from the expected sequence: {found_expected_patterns}"
    )
