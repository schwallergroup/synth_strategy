    ...
    def dfs_traverse(node, depth=0):
        if node["type"] == "reaction" and "rsmi" in node["metadata"]:
            ...
            # Fallback to functional group checking for protection
                ...
                print(
                    f"Found alcohol protection step (FG check) at depth {depth}: {rsmi}"
                )
                ...
                print(
                    f"Found amine protection step (FG check) at depth {depth}: {rsmi}"
                )
                ...
                print(
                    f"Found carboxylic acid protection step (FG check) at depth {depth}: {rsmi}"
                )
            ...
            # Fallback to functional group checking for deprotection
                ...
                print(
                    f"Found alcohol deprotection step (FG check) at depth {depth}: {rsmi}"
                )
                ...
                print(
                    f"Found amine deprotection step (FG check) at depth {depth}: {rsmi}"
                )
