...
def main(route):
    ...
    def dfs_traverse(node):
            ...
            if product_has_aldehyde:
                ...
                if reactants_with_aldehyde == 0:
                    ...
                    if checker.check_reaction("Friedel-Crafts acylation", rsmi):
                        for reactant in reactants_smiles:
                            if (
                                ...
                                print(
                                    f"Formylation detected via Friedel-Crafts acylation: {rsmi}"
                                )
                    ...
                    if (
                        ...
                        print(
                            f"Vilsmeier-Haack or similar formylation detected: {rsmi}"
                        )
                        formylation_found = True
                        return
                    ...
                    for reactant in reactants_smiles:
                        ...
                        if "C" in reactant and not checker.check_fg(
                            "Aldehyde", reactant
                        ):
                            ...
                            if any(
                                agent in "".join(reactants_smiles)
                                for agent in oxidizing_agents
                            ):
                    ...
                    for reactant in reactants_smiles:
                        if (
                            ...
                            print(
                                f"Formylation via hydrolysis of formyl derivative: {rsmi}"
                            )
                            formylation_found = True
                            return
                    ...
                    if (
                        any("C1N2CN3CN1CN(C2)C3" in r for r in reactants_smiles)
                        and aromatic_found
                    ):
                    ...
                    if carboxylic_derivative_found and h2_or_hydride_found:
                        print(
                            f"Formylation via reduction of carboxylic acid derivative: {rsmi}"
                        )
                        formylation_found = True
                        return
        ...
        for child in node.get("children", []):
            if (
                not formylation_found
            ):  # Only continue if we haven't found formylation yet
                dfs_traverse(child)
