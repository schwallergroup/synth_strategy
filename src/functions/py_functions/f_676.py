...
def main(route):
    ...
    def dfs_traverse(node, depth=0):
        ...
        # Check for bromination reactions
            ...
            if checker.check_reaction(
                "Aromatic bromination", rxn_smiles
    ...
    has_early_bromination = any(
        d >= early_stage_threshold for d in depths_with_bromination
    )
    ...
    if (
        max_depth > 2
        and (has_early_bromination or has_early_bromine)
        and has_late_bromine
    ):
