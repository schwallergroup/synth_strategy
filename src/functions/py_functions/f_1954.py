            ...
            if common_heterocycles and depth > 2:
                ...
                for rxn_type in modification_reactions:
                    if checker.check_reaction(rxn_type, rsmi):
                        ...
                        print(
                            f"Found heterocycle modification: {rxn_type} at depth {depth}"
                        )
                        break
                ...
                if not is_modification:
                    ...
                    for fg in functional_groups:
                        ...
                        if reactant_has_fg != product_has_fg:
                            is_modification = True
                            print(
                                f"Found heterocycle modification: {fg} change at depth {depth}"
                            )
                            break
                ...
                if not is_coupling:
                    ...
                    # Check for C-C or C-N bond formation between molecules
                        ...
                        # Check for N-C bond formation
                            ...
                            print(
                                f"Found potential N-C coupling reaction at depth {depth}"
                            )
                            is_coupling = True
                            coupling_reactions.append(
                                {
                                    "depth": depth,
                                    "reaction": "N-C_coupling",
                                    "reactants": reactants,
                                }
                            )
