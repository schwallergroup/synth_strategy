...
def main(route):
    ...
    def has_tms_group(smiles):
        ...
        return checker.check_fg(
            "TMS ether protective group", smiles
            ...
            if "metadata" in node and "rsmi" in node["metadata"]:
                ...
                try:
                    ...
                    for reaction_type in ether_formation_reactions:
                        ...
                        if (
                            reactants_have_alcohol
                            and reactants_have_halide
                            and product_has_ether
                        ):
                            if not any(checker.check_fg("Ether", r) for r in reactants):
                                print(
                                    f"Ether formation detected by alcohol+halide pattern: {rsmi}"
                                )
                                ether_formation_count += 1
                                print(
                                    f"Added 1 ether formation (alcohol+halide pattern)"
                                )
                        ...
                        # Check for alcohol consumption leading to ether formation
                            ...
                            if not product_has_alcohol or sum(
                                ...
                                if not any(
                                    ...
                                    ether_formation_count += 1
                                    print(
                                        f"Added 1 ether formation (alcohol consumption)"
                                    )
