...
def main(route):
    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "reaction":
            ...
            if product and reactants:
                ...
                halide_pattern = Chem.MolFromSmarts(
                    "[#6]-[#9,#17,#35,#53]"
                )  # C-F, C-Cl, C-Br, C-I
                ...
                if (
                    ...
                    aromatic_rings_in_reactants = sum(
                        len(Chem.GetSSSR(r)) for r in reactants if r
                    )
                    ...
                    if aromatic_rings_in_product >= aromatic_rings_in_reactants:
                        ...
                        print(
                            f"Found potential biaryl Suzuki coupling at depth {depth}"
                        )
    ...
    print(
        f"Biaryl formation via Suzuki coupling strategy detected: {biaryl_suzuki_found}"
    )
