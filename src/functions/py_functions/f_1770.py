            ...
            try:
                ...
                if is_suzuki:
                    ...
                    if not (has_boronic and has_halide):
                        print(
                            "Trying direct pattern matching for boronic acid and halides"
                        )
                        for reactant in reactants:
                    ...
                    print(
                        "Reaction not identified as Suzuki by checker, trying direct analysis"
                    )
                    reactants = rsmi.split(">")[0].split(".")
                    product = rsmi.split(">")[-1]
                    ...
                    has_halide = any(
                        any(x in r for x in ["Br", "Cl", "I"]) for r in reactants
                    )
