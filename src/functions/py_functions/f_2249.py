    ...
    def dfs_traverse(node, depth=0):
        if node["type"] == "reaction":
            ...
            try:
                ...
                print(
                    f"Product has aldehyde: {checker.check_fg('Aldehyde', product_smiles)}"
                )
                ...
                if checker.check_fg("Primary amine", product_smiles):
                    ...
                    # Check for nitrile reduction
                        ...
                        if checker.check_reaction(
                            ...
                            print(
                                f"Nitrile to amine reduction detected at depth {depth}"
                            )

                    # Check for amide reduction
                    elif any(
                        checker.check_fg("Primary amide", r) for r in reactants_smiles
                    ) or any(
