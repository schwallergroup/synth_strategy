        ...
        if node["type"] == "reaction" and not methyl_oxidation_found:
            try:
                    ...
                    if product_mol and checker.check_fg("Carboxylic acid", product):
                        ...
                        for reactant in reactants:
                            ...
                            if reactant_mol and reactant_mol.HasSubstructMatch(
                                ...
                                print(
                                    f"Found reactant with aromatic methyl: {reactant}"
                                )
                                ...
                                if methyl_count_reactant > product_methyl_count:
                                    print(
                                        "Methyl count decreased from reactant to product"
                                    )

                                    # Check if the carboxylic acid is attached to an aromatic ring
                                    aromatic_acid_pattern = Chem.MolFromSmarts(
                                        "c-C(=O)O"
                                    )
                                    if product_mol.HasSubstructMatch(
                                        aromatic_acid_pattern
                                    ):
                                        print(
                                            "Found aromatic carboxylic acid in product"
                                        )
                ...
                for reactant in reactants:
                    ...
                    ) or not checker.check_fg("Carboxylic acid", reactant):
                        if checker.check_fg("Carboxylic acid", product):
                            ...
                            if reactant_mol:
                                ...
                                if reactant_mol.HasSubstructMatch(
                                    ...
                                    print(
                                        f"Direct methyl to acid oxidation detected: {rsmi}"
                                    )
                                    methyl_oxidation_found = True
                                    break
