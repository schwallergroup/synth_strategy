    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "reaction":
            try:
                ...
                is_ester_aminolysis = checker.check_reaction(
                    "Aminolysis of esters", rsmi
                )
                ...
                if product_has_primary_amide and (
                    reactant_has_ester
                    or reactant_has_carbamate
                    or reactant_has_carbonic_ester
                ):
                ...
                if (
                    ...
                    and product_has_primary_amide
                    and is_nitrile_to_amide
                ):
