    ...
    def dfs_traverse(node):
        ...
        if (
            ...
            if (
                ...
                has_boc_protected_amine = (
                    checker.check_fg("Boc", product) if product else False
                )

                if (
                    has_primary_amine or has_secondary_amine
                ) and has_boc_protected_amine:
                    print(
                        f"Boc protection detected by functional group analysis: {rsmi}"
                    )
                    boc_protection_found = True
