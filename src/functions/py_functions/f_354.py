...
def main(route):
    ...
    difluoromethyl_pattern = Chem.MolFromSmarts(
        "c-C(F)(F)"
    )  # Difluoromethyl directly on benzene
    difluorobenzene_pattern = Chem.MolFromSmarts(
        "c1c(F)cc(F)cc1"
    )  # 1,3-difluorobenzene
    difluorobenzene_pattern2 = Chem.MolFromSmarts(
        "c1cc(F)c(F)cc1"
    )  # 1,2-difluorobenzene
    difluorobenzene_pattern3 = Chem.MolFromSmarts(
        "c1cc(F)cc(F)c1"
    )  # 1,4-difluorobenzene
                        ...
                        if reactant_mol:
                            ...
                            if (
                                ...
                                or reactant_mol.HasSubstructMatch(
                                    difluorobenzene_pattern
                                )
                                or reactant_mol.HasSubstructMatch(
                                    difluorobenzene_pattern2
                                )
                                or reactant_mol.HasSubstructMatch(
                                    difluorobenzene_pattern3
                                )
                            ):
                                has_difluoro = True
