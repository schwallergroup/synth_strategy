    ...
    def dfs_traverse(node, depth=0):
        ...
        if (
            ...
            if (
                ...
                protection_steps += 1
                print(
                    f"Depth {depth}: Boc protection step detected. Total: {protection_steps}"
                )
            ...
            # Silyl protection
                ...
                protection_steps += 1
                print(
                    f"Depth {depth}: Silyl protection step detected. Total: {protection_steps}"
                )
            ...
            # Boc deprotection
                ...
                protection_steps += 1
                print(
                    f"Depth {depth}: Boc deprotection step detected. Total: {protection_steps}"
                )
            ...
            # Silyl deprotection
                ...
                protection_steps += 1
                print(
                    f"Depth {depth}: Silyl deprotection step detected. Total: {protection_steps}"
                )
            ...
            # Benzyl deprotection
                ...
                protection_steps += 1
                print(
                    f"Depth {depth}: Benzyl deprotection detected. Total: {protection_steps}"
                )
            ...
            # TMS alkyne deprotection
                ...
                protection_steps += 1
                print(
                    f"Depth {depth}: TMS alkyne deprotection detected. Total: {protection_steps}"
                )
            ...
            # Amine deprotection
                ...
                protection_steps += 1
                print(
                    f"Depth {depth}: Amine deprotection detected. Total: {protection_steps}"
                )
            ...
            # Acetal/ketal protection
                ...
                protection_steps += 1
                print(
                    f"Depth {depth}: Acetal/ketal protection detected. Total: {protection_steps}"
                )
