                ...
                if checker.check_ring("pyrazole", product):
                    ...
                    if pyrazole_in_reactants:
                        ...
                        if (
                            ...
                            or checker.check_reaction(
                                "Acylation of primary amines", rsmi
                            )
                            or checker.check_reaction(
                                "Acylation of secondary amines", rsmi
                            )
                        ...
                        elif "C(=O)" in product and not any(
                            "C(=O)" in r for r in reactants
                        ):
                            pyrazole_modifications += 1
                            print(
                        ...
                        elif "C#C" in product and not any(
                            "C#C" in r for r in reactants
                        ):
                            pyrazole_modifications += 1
                            print(
