...
def main(route):
                ...
                for reactant in reactants:
                    ...
                    if reactant_mol and reactant_mol.HasSubstructMatch(
                        ...
                        if product_mol and product_mol.HasSubstructMatch(
                            ...
                            print(
                                f"Benzylic alcohol to halide transformation detected: {rsmi}"
                            )
                ...
                for reactant in reactants:
                    ...
                    if reactant_mol and reactant_mol.HasSubstructMatch(
                        ...
                        if product_mol and product_mol.HasSubstructMatch(
                            ...
                            print(
                                f"Benzylic halide to nitrile transformation detected: {rsmi}"
                            )
    ...
    if not sequence_found:
        sequence_found = (
            len(benzylic_alcohols) > 0
            and len(benzylic_halides) > 0
            and len(benzylic_nitriles) > 0
        )
