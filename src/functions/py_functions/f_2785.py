...
def main(route):
        ...
        if (
            ...
            if aldehyde_in_reactants and alkene_in_product:
                ...
                if wittig_reaction:
                    ...
                    print(
                        "  Detected conversion of aldehyde to alpha,beta-unsaturated carbonyl"
                    )
                    conversion_detected = True
                else:
            ...
            if aldehyde_in_reactants and not conversion_detected:
                if "CH2=" in product or "=[CH]" in product or "=[CH2]" in product:
                    print(
                        "  Detected potential aldehyde to alkene conversion (special pattern)"
                    )
                    conversion_detected = True
    ...
    dfs_traverse(route)
    print(
        f"Final result: Aldehyde to alkene conversion detected: {conversion_detected}"
    )
