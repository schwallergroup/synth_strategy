...
def main(route):
                ...
                if mol:
                    ...
                    if has_f and has_cl:
                        if depth == 0:  # Target molecule
                            ...
                            print(
                                f"Target molecule has F and Cl substituted aromatic system"
                            )
                        elif node.get("in_stock", False):  # Starting material
                            has_halogenated_aromatic_starting_material = True
                            print(
                                f"Starting material has F and Cl substituted aromatic system"
                            )
    ...
    return (
        has_halogenated_aromatic_target and has_halogenated_aromatic_starting_material
    )
