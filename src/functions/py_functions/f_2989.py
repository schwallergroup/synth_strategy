    ...
    def dfs_traverse(node, depth=0):
            ...
            if "metadata" in node and "rsmi" in node["metadata"]:
                ...
                if product_has_piperidine:
                    ...
                    if reactant_has_piperidine:
                        ...
                        print(
                            f"Depth {depth}: Detected piperidine scaffold maintained in reaction"
                        )
                    else:
                        print(
                    ...
                    if reactant_has_piperidine:
                        ...
                        print(
                            f"Depth {depth}: No piperidine scaffold involved in this reaction"
                        )
        ...
        # Check if molecule contains piperidine
            ...
            if has_piperidine:
                has_piperidine_anywhere = True
                print(
                    f"Depth {depth}: Molecule contains piperidine scaffold: {node['smiles']}"
                )
            else:
                print(
