        ...
        if node["type"] == "reaction":
            if "metadata" in node and "rsmi" in node["metadata"]:
                ...
                if (
                    ...
                    and not any(
                        checker.check_fg("Enamine", r) for r in reactants_smiles
                    )
                ):
                ...
                if any(
                    checker.check_reaction(rxn, rsmi) for rxn in halogenation_reactions
                ):
                ...
                # Also check for halogenation by comparing reactants and products
                    ...
                    if reactant_pyrazole and product_smiles:
                        ...
                        if (
                            ...
                            or product_smiles.count("Br")
                            > reactant_pyrazole.count("Br")
                ...
                if any(
                    checker.check_reaction(rxn, rsmi) for rxn in acylation_reactions
                ):
