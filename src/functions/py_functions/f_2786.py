    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "mol":
            ...
            if depth == 0:
                ...
                if (
                    "isoxazole" not in nitrogen_heterocycles_in_final
                    and "=NOC" in mol_smiles
                ):
                ...
                print(
                    f"Nitrogen heterocycles in final product: {nitrogen_heterocycles_in_final}"
                )
        ...
        # Check if this is a reaction node
            ...
            for ring_name in heterocycle_formation.keys():
                ...
                if not any_reactant_has_ring and product_has_ring:
                    print(
                        f"{ring_name.capitalize()} formation detected in reaction: {rsmi}"
                    )
