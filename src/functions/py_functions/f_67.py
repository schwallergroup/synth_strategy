    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "reaction":
            if "rsmi" in node.get("metadata", {}):
                ...
                if is_hydrolysis:
                    print(
                        f"Identified potential ester hydrolysis reaction at depth {depth}"
                    )
                    ...
                    carboxylic_acid_in_product = checker.check_fg(
                ...
                if not found_ester_hydrolysis:
                    ...
                    if ester_in_reactants and carboxylic_acid_in_product:
                        ...
                        water_in_reagents = any(
                            water in reagents for water in water_indicators
                        )
                        ...
                        # General case
                            ...
                            water_in_reactants
                            or water_in_reagents
                            or has_hydrolysis_reagents
                        ):
                            print(
