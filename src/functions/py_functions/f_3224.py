...
def main(route):
                        ...
                        for heterocycle in heterocycle_types:
                            if checker.check_ring(heterocycle, product_smiles):
                                ...
                                if not heterocycle_in_reactants:
                                    print(
                                        f"Heterocycle {heterocycle} formed in final step"
                                    )
                                    has_final_cyclization = True
    ...
    print(
        f"Reaction count: {reaction_count}, Max reactants per step: {max_reactants_per_step}"
    )
    print(
        f"Final cyclization: {has_final_cyclization}, Heterocycle formed: {heterocycle_formed}"
    )
