    ...
    def dfs_traverse(node):
        ...
        if node["type"] == "reaction" and "rsmi" in node.get("metadata", {}):
            ...
            if checker.check_reaction(
                ...
                print(
                    "Detected intramolecular Williamson ether synthesis via reaction pattern"
                )
                williamson_detected = True
                return
            ...
            has_alkyl_halide = (
                has_primary_halide or has_secondary_halide or has_tertiary_halide
            )
            ...
            if has_alcohol and has_halide and has_ether:
                print(
                    f"Detected Williamson-like ether synthesis: Alcohol + Halide → Ether"
                )
                williamson_detected = True
                return
