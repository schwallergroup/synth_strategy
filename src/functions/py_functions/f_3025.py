...
def main(route):
    ...
    def dfs_traverse(node, depth=0):
        ...
        ):  # Early-stage in retrosynthetic analysis
            try:
                ...
                if product_rings > reactant_rings:
                    ring_formation_detected = True
                    print(
                        "Ring formation detected: product has more rings than reactants"
                    )
                ...
                if ring_formation_detected:
                    ...
                    if final_product_rings and formed_rings_in_synthesis:
                        common_rings = final_product_rings.intersection(
                            formed_rings_in_synthesis
                        )
                        if common_rings:
                            print(
