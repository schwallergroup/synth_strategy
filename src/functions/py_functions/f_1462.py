...
def main(route):
    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "reaction":
            ...
            if product_mol and len(reactant_mols) >= 1:
                ...
                has_amine_product = product_mol and product_mol.HasSubstructMatch(
                    amine_pattern
                )
                ...
                protected_amine_pattern = Chem.MolFromSmarts(
                    "[#6]-[#7]-[#6](=[O])-[#8]-[#6]"
                )
                ...
                has_protected_amine_product = (
                    product_mol
                    and product_mol.HasSubstructMatch(protected_amine_pattern)
                )
                has_alkylated_amine_product = (
                    product_mol
    ...
    strategy_present = (
        ...
        and nitro_reduction_depth
        > amine_functionalization_depth
        > amide_formation_depth
    )
