        ...
        if (
            ...
            if depth <= 1:
                ...
                if checker.check_reaction("Hydrogenolysis of tertiary amines", rsmi):
                    print(
                        f"Found late-stage N-dealkylation via hydrogenolysis at depth {depth}"
                    )
                    print(f"Reaction SMILES: {rsmi}")
                    print(
                        f"Reactant (tertiary amine with allyl): {tertiary_amine_reactant}"
                    )
                ...
                if not checker.check_fg("Allyl", product) or (
                    ...
                    print(
                        f"Found late-stage N-dealkylation (general pattern) at depth {depth}"
                    )
                    print(f"Reaction SMILES: {rsmi}")
                    print(
                        f"Reactant (tertiary amine with allyl): {tertiary_amine_reactant}"
