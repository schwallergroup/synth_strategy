...
def main(route):
    ...
    def calculate_depth(node):
        ...
        return (
            node_depth if node_depth is not None else 3
        )  # Default to a reasonable depth
    ...
    def dfs_traverse(node):
        ...
        if (
            ...
            if depth <= 3:
                ...
                if len(reactants) >= 2:
                    print(
                        "Multiple reactants detected (potential convergent synthesis)"
                    )
                    ...
                    if product_has_ether:
                        ...
                        if not is_ether_formation:
                            ...
                            print(
                                f"Ether exists in reactants: {ether_exists_in_reactants}"
                            )
                            ...
                            if not ether_exists_in_reactants:
                                ...
                                print(
                                    "Inferred ether formation based on functional group analysis"
                                )
                        ...
                        if is_ether_formation:
                            print(
                                "Ether formation confirmed, checking reactant complexity"
                            )
                                    ...
                                    if r_mol:
                                        ...
                                        for ring_name in common_rings:
                                            if checker.check_ring(ring_name, r):
                                                has_ring = True
                                                print(
                                                    f"Reactant {i+1} contains {ring_name} ring"
                                                )
                                                break
