...
def main(route):
                ...
                for ring_type in heterocycle_rings:
                    if checker.check_ring(ring_type, product):
                        ...
                        reactants_have_heterocycle = any(
                            checker.check_ring(ring_type, reactant)
                            for reactant in reactants
                        )
                        ...
                        if not reactants_have_heterocycle:
                            ...
                            print(
                                f"Heterocycle formation ({ring_type}) detected at depth {depth}"
                            )
                            break
    ...
    for reaction in reaction_sequence:
        ...
        if (
            found_alkyne_step
            and reaction["forms_heterocycle"]
            and reaction["depth"] < alkyne_depth
        ):
            print(
