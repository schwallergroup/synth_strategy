                ...
                try:
                    ...
                    for reaction_type in amide_formation_reactions:
                        if checker.check_reaction(reaction_type, rsmi):
                            print(
                                f"Found potential amide formation reaction: {reaction_type}"
                            )
                            ...
                            if has_amide_in_product:
                                ...
                                print(
                                    f"Reaction type matches but no amide found in product"
                                )
                    ...
                    if not is_amide_formation:
                        ...
                        if (
                            has_acid_or_derivative
                            and has_amine
                            and has_amide_in_product
                        ):
                            print(
                                f"Detected amide formation from functional group analysis"
                            )
                            print(f"Reaction SMILES: {rsmi}")
                            is_amide_formation = True
