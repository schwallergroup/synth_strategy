    ...
    def dfs_traverse(node):
        ...
        if node["type"] == "reaction":
            if "rsmi" in node.get("metadata", {}):
                ...
                has_oxirane = any(
                    checker.check_ring("oxirane", r) for r in reactants if r
                )
                ...
                if not is_epoxide_opening:
                    ...
                    try:
                        ...
                        if (
                            ...
                            if (
                                has_oxirane
                                and not product_has_oxirane
                                and has_primary_alcohol
                            ):
                ...
                if has_oxirane and has_primary_alcohol and is_epoxide_opening:
                    print(
                        f"Ethylene oxide chain extension detected in reaction: {rsmi}"
                    )
