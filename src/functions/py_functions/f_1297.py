...
def main(route):
                ...
                for ring in hetero_rings:
                    if checker.check_ring(ring, product) and not any(
                        ...
                        if (
                            ...
                            print(
                                f"Detected C-O bond formation via {ring} ring formation"
                            )
                            c_o_bond = True
                        elif (
                            ring
                            ...
                            print(
                                f"Detected C-N bond formation via {ring} ring formation"
                            )
                            c_n_bond = True
                        elif (
                            ring
                            ...
                            print(
                                f"Detected C-S bond formation via {ring} ring formation"
                            )
                            c_s_bond = True
    ...
    print(
        f"C-O bond: {c_o_bond}, C-N bond: {c_n_bond}, C-S bond: {c_s_bond}, N-S bond: {n_s_bond}"
    )
