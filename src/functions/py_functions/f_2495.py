    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "reaction":
            ...
            if not is_alcohol_to_chloride and (
                "O=P(Cl)(Cl)Cl" in rsmi
                or "ClP(Cl)(Cl)=O" in rsmi
                or "O=P(Cl)(Cl)[Cl" in rsmi
            ):
                ...
                if product_has_heterocycle and product_has_chloride:
                    ...
                    for reactant in reactants:
                        ...
                        reactant_has_alcohol = any(
                            checker.check_fg(alcohol, reactant)
                        ...
                        if reactant_has_heterocycle and (
                            reactant_has_alcohol or reactant_has_oh
                        ):
            ...
            if (
                "Oc" in reactants_part
                and "Cl" in product
                and not is_alcohol_to_chloride
            ):
                for heterocycle in [
                    "pyridine",
                    "pyrimidine",
        ...
        for child in node.get("children", []):
            if (
                not hydroxyl_to_chloro
            ):  # Only continue if we haven't found the transformation yet
