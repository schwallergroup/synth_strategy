                ...
                if product and Chem.MolFromSmiles(product):
                    ...
                    for heterocycle in heterocycles:
                        if checker.check_ring(heterocycle, product):
                            print(
                                f"Found heterocycle {heterocycle} in product: {product}"
                            )
                        ...
                        for reactant in reactants:
                            if reactant and Chem.MolFromSmiles(reactant):
                                ...
                                reactant_ring_count = len(
                                    reactant_mol.GetRingInfo().AtomRings()
                                )
                                ...
                                if (
                                    ...
                                    print(
                                        f"Heterocycle formation detected at depth {depth}"
                                    )
                                    print(
                                        f"Reactant: {reactant} (rings: {reactant_ring_count})"
                                    )
                                    print(
                                        f"Product: {product} (rings: {product_ring_count})"
                                    )
