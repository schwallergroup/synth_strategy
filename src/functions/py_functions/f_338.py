...
def main(route):
        ...
        if node["type"] == "reaction":
            ...
            try:
                ...
                if product and all(r for r in reactants):
                    ...
                    has_halogenated_product = product.HasSubstructMatch(
                    ...
                    has_halogenated_reactant = any(
                        r.HasSubstructMatch(halogenation_pattern)
                        for r in reactants
                        if r
                    )
                    ...
                    if has_halogenated_reactant and has_heterocycle_reactant:
                        ...
                        halogen_count_reactants = sum(
                            len(r.GetSubstructMatches(halogenation_pattern))
                            for r in reactants
                            if r
                        )
    ...
    coupling_depths = [
        depth for mod_type, depth in heterocycle_mods if mod_type == "coupling"
    ]
