    ...
    def dfs_traverse(node):
        ...
        if node["type"] == "reaction":
            ...
            if is_final_step or metadata_depth == 0:
                ...
                is_suzuki_acids = checker.check_reaction(
                ...
                if any(
                    ...
                    print(
                        "Not a recognized Suzuki coupling reaction, performing additional checks"
                    )
                    ...
                    try:
                        ...
                        for reactant in reactants:
                            if checker.check_fg(
                                "Boronic acid", reactant
                            ) or checker.check_fg("Boronic ester", reactant):
                                print(
                                    f"Found boronic acid/ester in reactant: {reactant}"
                                )
                                has_boronic = True
                            if checker.check_fg(
                                ...
                                print(
                                    f"Found aryl halide/triflate in reactant: {reactant}"
                                )
