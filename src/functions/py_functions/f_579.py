...
def main(route):
    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "reaction":
            ...
            heterocycle_formed = (
                product_heterocycle and not reactant_has_same_heterocycle
            )
            ...
            if checker.check_ring("benzene", product_smiles):
                ...
                benzene_indices = checker.get_ring_atom_indices(
            ...
            if heterocycle_formed and benzene_count >= 2:
                ...
                print(
                    f"Found heterocycle formation with diphenyl substitution at depth {depth}"
                )
                print(
    ...
    print(
        f"Heterocycle formation with diphenyl substitution strategy detected: {strategy_present}"
    )
