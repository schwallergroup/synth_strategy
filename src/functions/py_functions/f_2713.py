    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "reaction":
            try:
                ...
                if heterocycle_found and checker.check_ring(
                    heterocycle_found, product_smiles
                ):
                ...
                for rxn_type in functionalization_reactions:
                    if checker.check_reaction(rxn_type, rsmi):
                        ...
                        print(
                            f"Detected heterocycle functionalization reaction: {rxn_type}"
                        )
                        break
                ...
                if heterocycle_in_reactants and heterocycle_in_product:
                    ...
                    if is_functionalization_rxn:
                        ...
                        print(
                            "Confirmed heterocycle functionalization strategy via known reaction"
                        )
                        result = True
                        return
                    else:
                        ...
                        if reactant_mol and product_mol:
                            ...
                            if Chem.MolToSmiles(reactant_mol) != Chem.MolToSmiles(
                                product_mol
                            ):
                                ...
                                if (
                                    (
                                        checker.check_fg(
                                            "Aromatic halide", heterocycle_reactant
                                        )
