    ...
    def dfs_traverse(node):
        if (
            ...
            try:
                ...
                product_has_ester = product_mol and product_mol.HasSubstructMatch(
                    ester_pattern
                )
                product_has_amide = product_mol and product_mol.HasSubstructMatch(
                    amide_pattern
                )
                product_has_amine = product_mol and product_mol.HasSubstructMatch(
                    amine_pattern
                )
                ...
                if reactants_have_ester and product_has_amide and not product_has_ester:
                    ...
                    reactants_have_amide and product_has_amine and not product_has_amide
                ):
