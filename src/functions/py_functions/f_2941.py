...
def main(route):
    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "reaction":
            ...
            try:
                ...
                product_has_carboxylic = checker.check_fg(
                ...
                is_transesterification = checker.check_reaction(
                ...
                if forward_esterification:
                    ...
                    print(
                        f"Reverse esterification (hydrolysis) detected at depth {depth}"
                    )
                    esterification_found = True
                    esterification_depth = depth
    ...
    result = (
        esterification_found
        and (esterification_depth is not None)
        and (esterification_depth <= 1)
    )
