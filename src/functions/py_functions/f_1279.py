...
def main(route):
                ...
                for reactant in reactants.split("."):
                    if (
                        ...
                        if checker.check_fg(
                            ...
                            has_tbdms_protection = True
                            print(
                                f"Found silyl protection reaction at depth {depth}: {rsmi}"
                            )
                            break
            ...
            # Alternative check: silyl ether → alcohol
                ...
                for reactant in reactants.split("."):
                    if checker.check_fg(
                        ...
                        has_tbdms_deprotection = True
                        print(
                            f"Found silyl deprotection reaction at depth {depth}: {rsmi}"
                        )
                        break
    ...
    # Report findings
    print(
        f"Protection found: {has_tbdms_protection}, Deprotection found: {has_tbdms_deprotection}"
    )
