        ...
        if node["type"] == "mol":
            ...
            if mol:
                ...
                if (
                    ...
                    and "aldehyde" not in sequence
                ):
                    sequence.append("aldehyde")
                    print(f"Aldehyde detected: {node['smiles']}")
                elif (
                    mol.HasSubstructMatch(alcohol_pattern) and "alcohol" not in sequence
                ):
                    ...
                    mol.HasSubstructMatch(nitrile_pattern) and "nitrile" not in sequence
                ):
