...
def main(route):
                ...
                if is_heterocycle_formation:
                    ...
                    for r in reactants_smiles:
                        ...
                        if linker_fgs_in_reactant:
                            reactants_with_linker_fgs.append(
                                (r, linker_fgs_in_reactant)
                            )
    ...
    if found_linker_installation and found_heterocycle_formation:
        ...
        if linker_installation_depth > heterocycle_formation_depth:
            print(
                "Found strategy: linker installation followed by heterocycle formation"
            )
    ...
    if found_linker_installation and found_heterocycle_formation:
        print(
            "Found linker installation and heterocycle formation, but not in the expected order"
        )
        return True
