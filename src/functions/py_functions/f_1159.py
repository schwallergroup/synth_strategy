    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "reaction":
            ...
            try:
                ...
                main_reactant_mol = (
                    Chem.MolFromSmiles(main_reactant) if main_reactant else None
                )
                ...
                if product_mol and main_reactant_mol:
                    ...
                    if has_halogen_reactant:
                        ...
                        if checker.check_reaction("Williamson Ether Synthesis", rsmi):
                            ...
                            or checker.check_reaction(
                                "Aromatic nitration with HNO3", rsmi
                            )
                            or checker.check_reaction(
                            ...
                            if (
                                ...
                                transformation_sequence.append(
                                    ("halogen_to_thiol", depth)
                                )
                                print(f"Detected halogen to thiol at depth {depth}")
                            else:
                                # Generic halogen replacement
                                transformation_sequence.append(
                                    ("halogen_replacement", depth)
                                )
                                print(
                                    f"Detected generic halogen replacement at depth {depth}"
                                )
