        ...
        if (
            ...
            if is_reduction:
                ...
                if has_aldehyde_reactant and has_primary_alcohol_product:
                    ...
                    print(
                        "Aldehyde reduction to alcohol detected (reverse of target reaction)"
                    )
                    oxidation_found = True
            ...
            if not oxidation_found and not is_oxidation and not is_reduction:
                ...
                has_aldehyde_product = checker.check_fg(
                    "Aldehyde", product
                ) or checker.check_fg("Formaldehyde", product)
                ...
                if (has_primary_alcohol_reactant and has_aldehyde_product) or (
                    ...
                    if not is_other_reaction:
                        print(
                            "Alcohol oxidation/reduction confirmed by functional group change"
                        )
                        oxidation_found = True
