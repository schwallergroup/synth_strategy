...
def main(route):
            ...
            if "metadata" in node and "rsmi" in node["metadata"]:
                ...
                try:
                    ...
                    if (
                        ...
                        or checker.check_reaction(
                            "Aryl halide to carboxylic acid", rsmi
                        )
                        or checker.check_reaction(
                        ...
                        print(
                            f"Found carbonyl_introduction at depth: {depth}, reaction: {rsmi}"
                        )
                    ...
                    # Check for carbonyl reduction reactions
                        ...
                        print(
                            f"Found carbonyl_reduction at depth: {depth}, reaction: {rsmi}"
                        )
    ...
    if not has_cycle:
        introductions = [
            d for d, rt, _ in reaction_sequence if rt == "carbonyl_introduction"
        ]
