    ...
    def dfs_traverse(node):
        ...
        if (
            ...
            if checker.check_reaction(
                ...
                "anti-Markovnikov alkene hydration to alcohol", rsmi
            ):
                ...
                for reactant in reactants:
                    if checker.check_fg("Alkene", reactant) or checker.check_fg(
                        "Vinyl", reactant
                    ):
                ...
                if reactant_has_alkene and product_has_alcohol:
                    ...
                    if "H2O" in rsmi or "OH" in rsmi:
                        print(
                            f"Alkene hydration detected through pattern matching: {rsmi}"
                        )
                        hydration_found = True
