...
def main(route):
        ...
        if node["type"] == "mol":
            ...
            try:
                ...
                if product_heterocycle and not reactant_heterocycle:
                    ...
                    print(
                        f"Detected heterocycle formation: {product_heterocycle} at depth {depth}"
                    )
                ...
                # Functionalization: both product and reactants have the same heterocycle
                    ...
                    if not functionalization_detected:
                        ...
                        removed_fgs = [
                            fg for fg in reactant_fgs if fg not in product_fgs
                        ]
    ...
    for path_id, molecules in heterocycle_paths.items():
        ...
        if len(heterocycle_types) == 1:
            ...
            functionalizations = [
                ...
                if t[0] == "functionalization"
                and t[1] == heterocycle_type
                and t[3] == path_id
            ]
    ...
    pyridine_functionalizations = [
        t
        for t in transformation_sequence
        if t[0] == "functionalization" and t[1] == "pyridine"
    ]
