                ...
                for reactant in reactants:
                    ...
                    for ring in cyclic_amide_rings:
                        if checker.check_ring(ring, reactant):
                            print(
                                f"Found cyclic amide ring ({ring}) in reactant: {reactant}"
                            )
                    ...
                    if (
                        ...
                        if mol:
                            ...
                            if ring_info.NumRings() > 0 and checker.check_fg(
                                ...
                                print(
                                    f"Found potential cyclic amide in reactant: {reactant}"
                                )
                                has_cyclic_amide = True
                    ...
                    if has_cyclic_amide:
                        ...
                        if has_amine and has_carboxylic_acid:
                            print(
                                f"Found amine and carboxylic acid in product: {product}"
                            )
