                ...
                for reactant in reactants:
                    if checker.check_fg("Tertiary amine", reactant):
                        ...
                        if checker.check_reaction(
                            "Hydrogenolysis of tertiary amines", rsmi
                        ):
                            print(
                        ...
                        if "[" in rsmi and ":" in rsmi:  # Check if atom mapping exists
                            try:
                                ...
                                if product_mol and reactant_mol:
                                    ...
                                    print(
                                        f"Secondary N atoms in product: {secondary_n_atoms}"
                                    )
                                    print(
                                        f"Tertiary N atoms in reactant: {tertiary_n_atoms}"
                                    )
                        ...
                        try:
                            ...
                            if product_mol and reactant_mol:
                                ...
                                if n_methyl_pattern:
                                    ...
                                    if (
                                        reactant_n_methyl_matches
                                        > product_n_methyl_matches
                                    ):
                                        print(
