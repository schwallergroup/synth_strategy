    ...
    def dfs_traverse(node):
        ...
        if node["type"] == "reaction":
            ...
            if product_mol and reactant_mols:
                ...
                product_has_bromide = product_mol and product_mol.HasSubstructMatch(
                    bromide_pattern
                )
                product_has_alcohol = product_mol and product_mol.HasSubstructMatch(
                    alcohol_pattern
                )
                ...
                if (
                    (
                        reactant_has_chloride
                        and (product_has_alcohol or product_has_bromide)
                    )
                    or (
                        reactant_has_bromide
                        and (product_has_alcohol or product_has_chloride)
                    )
                    or (
                        reactant_has_alcohol
                        and (product_has_chloride or product_has_bromide)
                    )
                ):
