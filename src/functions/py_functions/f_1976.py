            ...
            if "rsmi" in node.get("metadata", {}):
                ...
                try:
                    ...
                    if product_mol:
                        ...
                        product_has_carbonate = product_mol.HasSubstructMatch(
                            carbonate_pattern
                        )
                        ...
                        if product_has_ester or product_has_carbonate:
                            ...
                            chloroformate_pattern = Chem.MolFromSmarts(
                                "[F,Cl,Br,I]C(=O)O[#6]"
                            )
                            ...
                            if (
                                ...
                                print(
                                    f"Ester/carbonate was formed in step at depth {depth}"
                                )
                                late_stage_has_esterification = True
                                ...
                                if checker.check_reaction("Transesterification", rsmi):
                                    print(
                                        f"Detected transesterification at depth {depth}"
                                    )
                                    late_stage_has_esterification = True
                        else:
