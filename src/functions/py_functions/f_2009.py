                    ...
                    if (
                        ...
                        if (
                            ...
                            or checker.check_reaction(
                                "Sulfanyl to sulfinyl_peroxide", rsmi
                            )
                            ...
                            or checker.check_reaction(
                                "Sulfanyl to sulfinyl_sulfonyl", rsmi
                            )
                            ...
                            print(
                                f"Confirmed sulfone formation reaction at depth {depth}: {rsmi}"
                            )
                        ...
                        try:
                            ...
                            if product_sulfone_indices:
                                ...
                                reactant_thioether_indices = (
                                    checker.get_fg_atom_indices("Monosulfide", reactant)
                                )
