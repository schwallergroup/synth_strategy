        ...
        if (
            ...
            if depth <= 1:
                ...
                for reactant in reactants:
                    ...
                    if not is_aromatic_amine and checker.check_fg(
                    ...
                    if is_aromatic_amine:
                        ...
                        if (
                            aromatic_amine_count_reactants
                            > aromatic_amine_count_product
                        ):
                            print(
                                f"Aromatic amine was consumed in the reaction (capping)"
                            )
                        ...
                        for reaction_type in capping_reactions:
                            if checker.check_reaction(reaction_type, rsmi):
                                print(
                                    f"Detected aromatic amine capping reaction: {reaction_type}"
                                )
                                aromatic_amine_capping = True
                                break
                        ...
                        if not aromatic_amine_capping:
                            ...
                            if (
                                ...
                                print(
                                    f"Aromatic amine converted to sulfonamide (capping)"
                                )
                                aromatic_amine_capping = True
                                break
