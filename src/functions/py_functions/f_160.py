    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "reaction" and "rsmi" in node.get("metadata", {}):
                ...
                if has_n_c_f or has_n_cf2 or has_n_cf3:
                    ...
                    if not pattern_in_reactants:
                        ...
                        if has_nitrogen_reactant:
                            print(
                                f"N-fluoroalkylation pattern detected at depth {depth}"
                            )
                    ...
                    if checker.check_fg(fg, product):
                        ...
                        if fg in [
                            ...
                            if product_mol:
                                ...
                                if f_atoms:
                                    print(
                                        f"Product contains fluorine atoms at depth {depth}"
                                    )
                    ...
                    if not reactant_has_fluoroalkyl:
                        ...
                        if product_mol:
                            ...
                            if product_mol.HasSubstructMatch(n_c_f_pattern):
                                print(
                                    f"N-fluoroalkylation confirmed at depth {depth}: {rsmi}"
                                )
                                fluoroalkylation_detected = True
            ...
            if depth == 5 and not fluoroalkylation_detected:
                ...
                if (
                    "O=S(=O)(O[CH2:10][CH:11]([F:12])[F:13])C(F)(F)F" in rsmi
                    and "[NH:9]" in rsmi
                ):
                    print(
