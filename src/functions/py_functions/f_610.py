...
def main(route):
    ...
    strategy_present = (
        has_trifluoromethyl and has_heterocycle and trifluoromethyl_preserved
    )

    print(
        f"Trifluoromethyl-containing heterocycle synthesis strategy detected: {strategy_present}"
    )
    print(f"  - Has trifluoromethyl group: {has_trifluoromethyl}")
    print(f"  - Has heterocycle: {has_heterocycle}")
    print(
        f"  - Trifluoromethyl preserved in final product: {trifluoromethyl_preserved}"
    )
