...
def main(route):
    ...
    def dfs_traverse(node, depth=0):
        ...
        if (
        ...
        ):  # Consider reactions within first four steps
            if "rsmi" in node.get("metadata", {}):
                ...
                is_sulfonamide_formation = (
                    is_primary_sulfonamide or is_secondary_sulfonamide
                )
                ...
                if (
                    ...
                    print(
                        f"Detected sulfonamide formation by component analysis at depth {depth}"
                    )
                ...
                if is_sulfonamide_formation or (
                    ...
                    print(
                        f"Confirmed late-stage sulfonamide formation at depth {depth}"
                    )
