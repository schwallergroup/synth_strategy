...
def main(route):
        ...
        if node["type"] == "reaction":
            ...
            try:
                ...
                if (
                    ...
                    print(
                        f"Found sulfur oxidation (thioether → sulfoxide) at depth {depth}"
                    )
                ...
                if (
                    ...
                    print(
                        f"Found sulfur oxidation (thioether → sulfone) at depth {depth}"
                    )
                    oxidation_events.append((depth, reactants, product))
                    has_oxidation = True
                ...
                if (
                    ...
                    print(
                        f"Found sulfur oxidation (sulfoxide → sulfone) at depth {depth}"
                    )
                    oxidation_events.append((depth, reactants, product))
                    has_oxidation = True
                ...
                if (
                    ...
                    print(
                        f"Found sulfur reduction (sulfone → sulfoxide) at depth {depth}"
                    )
                ...
                if (
                    ...
                    print(
                        f"Found sulfur reduction (sulfone → thioether) at depth {depth}"
                    )
                    reduction_events.append((depth, reactants, product))
                    has_reduction = True
                ...
                if (
                    ...
                    print(
                        f"Found sulfur reduction (sulfoxide → thioether) at depth {depth}"
                    )
                    reduction_events.append((depth, reactants, product))
                    has_reduction = True
                ...
                if rxn_smiles:
                    ...
                    if (
                        ...
                        or checker.check_reaction(
                            "Sulfanyl to sulfinyl_peroxide", rxn_smiles
                        )
                        or checker.check_reaction(
                            "Sulfanyl to sulfinyl_H2O2", rxn_smiles
                        )
                        or checker.check_reaction(
                            "Sulfanyl to sulfinyl_H2O", rxn_smiles
                        )
                        or checker.check_reaction(
                            "Sulfanyl to sulfinyl_SO3-", rxn_smiles
                        )
                        or checker.check_reaction(
                            "Sulfanyl to sulfinyl_sulfonyl", rxn_smiles
                        )
                        or checker.check_reaction(
                            "Sulfanyl to sulfinyl_MeOH", rxn_smiles
                        )
                        or checker.check_reaction(
                            "Sulfanyl to sulfinyl_COO", rxn_smiles
                        )
                    ):
                    ...
                    if checker.check_reaction("thia-Michael addition", rxn_smiles):
                        ...
                        print(
                            f"Found potential sulfur reduction reaction at depth {depth}"
                        )
                    ...
                    if checker.check_reaction(
                        "Cleavage of sulfons and sulfoxides", rxn_smiles
                    ):
    ...
    print(
        f"Oxidation events: {len(oxidation_events)}, Reduction events: {len(reduction_events)}"
    )
    ...
    if has_oxidation and not has_reduction:
        ...
        if check_potential_reduction(route):
            print(
                "Detected potential unlabeled sulfur reduction - considering as redox cycling"
            )
