...
def main(route):
                    ...
                    if checker.check_reaction(reaction_type, rsmi):
                        ...
                        if "Stille" in reaction_type:
                            ...
                            for reactant in reactants:
                                if "[Sn]" in reactant or checker.check_fg(
                                    "Tin", reactant
                                ):
                            ...
                            for reactant in reactants:
                                if checker.check_fg("Aromatic halide", reactant):
                                    ...
                                    cross_coupling_depth = depth
                                    print(
                                        f"Found {reaction_type} reaction at depth {depth}"
                                    )
                                    break
                ...
                if not found_cross_coupling:
                    ...
                    if (
                        ...
                        if has_coupling_partner:
                            ...
                            cross_coupling_depth = depth
                            print(
                                f"Found general cross-coupling pattern at depth {depth}"
                            )
            ...
            # Check if this is a halogenation reaction
                ...
                for reaction_type in halogenation_reactions:
                    if checker.check_reaction(reaction_type, rsmi):
                        ...
                        has_halogen_in_product = checker.check_fg(
                            "Aromatic halide", product
                        )
                ...
                if not found_halogenation:
                    ...
                    if has_halogen_in_product and not has_halogen_in_reactants:
                        ...
                        halogenation_depth = depth
                        print(
                            f"Found halogenation (functional group change) at depth {depth}"
                        )
    ...
    if strategy_present:
        ...
        if found_halogenation and not found_cross_coupling:
            ...
            print(
                "Found cross-coupling at late stage but no halogenation in earlier steps"
            )
