            ...
            try:
                ...
                if checker.check_fg("Aromatic halide", product):
                    ...
                    for r in reactants:
                        ...
                        if len(r) > 5 and not any(
                            reagent in r for reagent in common_reagents
                        ):
                            main_reactant = r
                            break
                    ...
                    if main_reactant:
                        ...
                        if not checker.check_fg("Aromatic halide", main_reactant):
                            print(
                                f"Found aromatic halogenation (FG analysis) at depth {depth}"
                            )
                            result = True
                            return
                        else:
                            ...
                            if len(product_halide_indices) > len(
                                reactant_halide_indices
                            ):
                                print(
