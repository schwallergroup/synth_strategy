        ...
        if (
            ...
            if not suzuki_coupling_found:
                try:
                    ...
                    print(
                        f"Boronic present: {boronic_present}, Halide present: {halide_present}"
                    )
                    ...
                    print(
                        f"Pd present: {pd_present}, Phosphine present: {phosphine_present}"
                    )
                    ...
                    if (
                        boronic_present
                        and halide_present
                        and (pd_present or phosphine_present)
                    ):
                        suzuki_coupling_found = True
                        print(
