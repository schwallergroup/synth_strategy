            ...
            if not is_starting_material:
                try:
                    ...
                    if not has_thiophene:
                        ...
                        print(
                            f"Found thiophene in molecule at depth {depth}: {mol_smiles}"
                        )
                except Exception as e:
                    print(
                        f"Error checking thiophene in molecule: {mol_smiles}, Error: {e}"
                    )
            else:
                print(
                    f"Skipping starting material check at depth {depth}: {mol_smiles}"
                )
