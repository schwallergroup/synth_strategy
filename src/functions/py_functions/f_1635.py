...
def main(route):
        ...
        if (
            ...
            if is_sulfonamide_reaction and product_has_sulfonamide:
                ...
                has_reactant_without_sulfonamide = any(
                    not checker.check_fg("Sulfonamide", reactant)
                ...
                if has_reactant_without_sulfonamide:
                    ...
                    if (
                        not found_sulfonamide_formation
                        or depth < sulfonamide_formation_depth
                    ):
                        found_sulfonamide_formation = True
                        sulfonamide_formation_depth = depth
                        print(
                            f"Found sulfonamide formation at depth {depth}, reaction: {rsmi}"
                        )
    ...
    if found_sulfonamide_formation and max_depth > 0:
        ...
        print(
            f"Max depth: {max_depth}, Sulfonamide formation not found or max_depth is 0"
        )
