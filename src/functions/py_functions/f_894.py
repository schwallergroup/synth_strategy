...
def main(route):
    ...
    def dfs_traverse(node):
        ...
        if (
            ...
            reactant_has_amine = (
                reactant_has_primary_amine or reactant_has_secondary_amine
            )
            ...
            product_has_amine = (
                product_has_secondary_amine or product_has_tertiary_amine
            )

            if reactant_has_carbonyl and reactant_has_amine and product_has_amine:
                print(
                    f"Inferred reductive amination pattern from functional groups: {rsmi}"
                )
