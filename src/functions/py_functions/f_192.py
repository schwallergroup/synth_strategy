                ...
                try:
                    ...
                    if (
                        ...
                        if (
                            ...
                            print(
                                f"Detected ester hydrolysis at depth {depth}, reaction: {rsmi}"
                            )
                            print(f"  - Ester in reactants: {has_ester_reactant}")
                            print(
                                f"  - Thioester in reactants: {has_thioester_reactant}"
                            )
                            print(
                                f"  - Carboxylic acid in products: {has_carboxylic_product}"
                            )
