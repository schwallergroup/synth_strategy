        ...
        if (
            ...
            try:
                ...
                for r in reactants:
                    ...
                    if (
                        mol.GetNumAtoms() > 15
                        and not is_common_reagent
                        and not is_small_molecule
                    ):
                        complex_reactants += 1
                        if debug:
                            print(
                                f"Complex reactant found: {r} with {mol.GetNumAtoms()} atoms"
                            )
                ...
                if complex_reactants > 1 or (
                    ...
                    and len(reactants) > 1
                    and complex_reactants > 0
                ):
                    is_linear = False
                    if debug:
                        print(
                            f"Found convergent step with multiple complex reactants: {rsmi}"
                        )
