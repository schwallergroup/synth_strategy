...
def main(route):
        ...
        # Process reaction nodes
            ...
            try:
                ...
                if (
                    ...
                    if (
                        has_pyridine_reactant
                        and has_piperidine_reactant
    ...
    if has_connection and any(depth == 0 for _, depth in connection_nodes):
        print(
            "Found linear pyridine-piperidine connection strategy (already connected in target)"
        )
        return True
    ...
    if has_pyridine and has_piperidine and has_connection:
        ...
        isolated_pyridine = any(
            depth > min_connection_depth for _, depth in pyridine_nodes
        )
        isolated_piperidine = any(
            depth > min_connection_depth for _, depth in piperidine_nodes
        )
