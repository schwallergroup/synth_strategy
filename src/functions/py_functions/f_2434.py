...
def main(route):
                ...
                if not chlorinations or depth not in chlorinations:
                    ...
                    if product_mol and "Cl" in product_smiles:
                        ...
                        if checker.check_ring("pyridine", product_smiles) and any(
                            ...
                            for reactant in reactants_smiles:
                                if "=O" in reactant and checker.check_ring(
                                    "pyridine", reactant
                                ):
                                    chlorinations.append(depth)
                                    print(
                                        f"Detected pyridine chlorination at depth {depth}"
                                    )
                                    break
                ...
                for reaction_name in amination_reactions:
                    if checker.check_reaction(reaction_name, rsmi):
                        ...
                        if (
                            ...
                            print(
                                f"Detected amination reaction {reaction_name} at depth {depth}"
                            )
                            break
                ...
                if not aminations or depth not in aminations:
                    for reactant in reactants_smiles:
                        if (
                            ...
                            aminations.append(depth)
                            print(
                                f"Detected halide to amine transformation at depth {depth}"
                            )
                            break
    ...
    correct_sequence = (
        min_heterocycle_depth > min_chlorination_depth > min_amination_depth
    )
