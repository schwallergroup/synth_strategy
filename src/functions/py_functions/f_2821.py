        ...
        if (
            ...
            try:
                ...
                if product_mol and reactant_mols:
                    ...
                    product_ar_br_count = len(
                        product_mol.GetSubstructMatches(ar_br_pattern)
                    )

                    if product_ar_br_count > 0:
                        print(
                            f"Product contains {product_ar_br_count} aromatic-Br bonds"
                        )
                ...
                if (
                    ...
                    if (
                        ...
                        print(
                            f"Late-stage Wohl-Ziegler bromination detected at depth {depth}"
                        )
                        late_bromination_detected = True
                        return
