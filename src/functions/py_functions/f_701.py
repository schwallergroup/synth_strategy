...
def main(route):
    ...
    def dfs_traverse(node, depth=0):
        ...
        if (
        ...
        ):  # Final or penultimate reaction (late stage)
                ...
                if not is_epoxidation and has_vinyl_reactant and has_epoxide_product:
                    ...
                    for reactant in reactants_smiles:
                        if checker.check_ring("oxirane", reactant):
                            ...
                            print(
                                "Epoxide already present in reactant, not a new formation"
                            )
                            break
                    ...
                    if not epoxide_in_reactants:
                        ...
                        if any(oxidant in reagents for oxidant in oxidants):
                            is_epoxidation = True
                            print(
                                "Identified as general epoxidation reaction (oxidation present)"
                            )
                        else:
            ...
            if has_vinyl_reactant and has_epoxide_product and is_epoxidation:
                ...
                print(
                    f"Found epoxidation at depth {depth}: vinyl group converted to epoxide"
                )
