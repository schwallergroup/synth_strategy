        ...
        if (
            ...
            for reaction_type in n_functionalization_reactions:
                if checker.check_reaction(reaction_type, rsmi):
                    ...
                    print(
                        f"Nitrogen functionalization found at depth {depth}: {reaction_type}"
                    )
            ...
            if not any(
                ...
                for rxn in n_functionalization_reactions
            ):
                ...
                try:
                    ...
                    reactant_has_n = any(
                        any(checker.check_fg(fg, r) for fg in reactant_n_groups)
                        for r in reactants
                    )
                    product_has_n = any(
                        checker.check_fg(fg, product) for fg in product_n_groups
                    )
                    ...
                    if reactant_has_n and product_has_n:
                        ...
                        if reactant_n_types != product_n_types:
                            n_functionalization_depths.append(depth)
                            print(
                                f"Potential nitrogen functionalization found at depth {depth}"
                            )
                            print(f"Reaction SMILES: {rsmi}")
