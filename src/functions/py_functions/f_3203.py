                    ...
                    try:
                        ...
                        for reactant in reactants:
                            if checker.check_fg("Carboxylic acid", reactant):
                                ...
                                print(
                                    f"{indent}  Found carboxylic acid in reactants: {reactant}"
                                )
                                break
                        ...
                        has_acid_in_product = checker.check_fg(
                        ...
                        if has_acid_in_reactants and has_ester_in_product:
                            ...
                            print(
                                f"{indent}  This appears to be a forward esterification reaction"
                            )
                            has_esterification = True
                        ...
                        # Check for reverse esterification (ester → acid, which is hydrolysis)
                            ...
                            print(
                                f"{indent}  Found carboxylic acid in product: {product}"
                            )
                            print(
                        ...
                        # Check for other ester-forming reactions
                            ...
                            for reactant in reactants:
                                if checker.check_fg("Acyl halide", reactant):
                                    ...
                                    print(
                                        f"{indent}  Found acyl halide in reactants: {reactant}"
                                    )
                                if (
                                    ...
                                    has_alcohol = True
                                    print(
                                        f"{indent}  Found alcohol in reactants: {reactant}"
                                    )

                            if has_acyl_halide and has_alcohol and has_ester_in_product:
                                print(
                                    f"{indent}  This appears to be an acyl halide esterification"
                                )
                                has_esterification = True
