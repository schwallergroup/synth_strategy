...
def main(route):
                ...
                if len(reactants) >= 2:
                    ...
                    for reactant in reactants:
                        ...
                        if checker.check_ring(
                            "pyrazole", reactant
                        ) or checker.check_ring("pyrimidine", reactant):
                    ...
                    if (
                        ...
                        print(
                            "Found nucleophilic substitution reaction at coupling step"
                        )
            ...
            if depth >= 1 and depth <= 5:
                ...
                for reactant in reactants:
                    if checker.check_ring("pyrazole", reactant) or checker.check_ring(
                        ...
                        if "Cl" in reactant:
                            print(
                                f"Found chlorinated pyrazolopyrimidine at depth {depth}"
                            )
                            found_chlorination = True
            ...
            if depth >= 2 and depth <= 5:
                ...
                if (
                    ...
                    if has_halide and has_boronic:
                        print(
                            f"Found cross-coupling reaction (Suzuki) at depth {depth}"
                        )
                        found_cross_coupling = True
    ...
    transformations_found = sum(
        [
            found_oxidation,
            found_chlorination,
            found_cross_coupling,
            found_nucleophilic_substitution,
        ]
    )
