                        ...
                        if checker.check_fg(
                            ...
                            for other_reactant in reactants:
                                if other_reactant != reactant and (
                                    ...
                                    or checker.check_fg(
                                        "Secondary amine", other_reactant
                                    )
                                    ...
                                    if checker.check_fg("Nitro group", product) and (
                                        ...
                                        print(
                                            f"Confirmed nitro-activated SNAr product: {product}"
                                        )
                ...
                if not nitro_activated_snar_found:
                    for reactant in reactants:
                        ...
                        if checker.check_fg(
                            ...
                            print(
                                f"Found nitro-activated haloarene (alt method): {reactant}"
                            )
                            ...
                            for other_reactant in reactants:
                                if other_reactant != reactant and (
                                    ...
                                    amine_found = True
                                    print(
                                        f"Found amine nucleophile (alt method): {other_reactant}"
                                    )
                                    break
