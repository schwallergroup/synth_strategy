                        ...
                        if checker.check_reaction(
                            ...
                            try:
                                ...
                                if reactant_mol and product_mol:
                                    ...
                                    if nitrile_indices:
                                        for match in nitrile_indices:
                                            for (
                                                ...
                                                match
                                            ):  # Each match is already a tuple of indices
                                                atom = reactant_mol.GetAtomWithIdx(
                                                    atom_idx
                                                )
                                                if atom.GetSymbol() == "C":
                                    ...
                                    if aldehyde_indices:
                                        for match in aldehyde_indices:
                                            for (
                                                ...
                                                atom = product_mol.GetAtomWithIdx(
                                                    atom_idx
                                                )
                                                if atom.GetSymbol() == "C":
                                                    map_num = atom.GetAtomMapNum()
                                    ...
                                    common_map_nums = nitrile_carbons.intersection(
                                        aldehyde_carbons
                                    )
                                    if common_map_nums:
                                        print(
                                ...
                                if "C1CCOC1.CC(C)C[Al+]CC(C)C" in rsmi.split(">")[1]:
                                    print(
                                        "Detected DIBAL-H reduction pattern despite error"
                                    )
                                    nitrile_to_aldehyde = True
