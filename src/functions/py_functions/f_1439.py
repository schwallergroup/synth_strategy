        ...
        if node["type"] == "reaction":
            if "rsmi" in node.get("metadata", {}):
                ...
                if checker.check_reaction("reductive amination with aldehyde", rsmi):
                    ...
                    print(
                        "Using fallback method to check for reductive amination pattern"
                    )
                    try:
                            ...
                            if carbonyl_reactant and amine_reactant:
                                ...
                                if has_amine:
                                    ...
                                    try:
                                        ...
                                        carbonyl_mol = Chem.MolFromSmiles(
                                            carbonyl_reactant
                                        )
                                        ...
                                        print(
                                            f"Error in atom mapping verification: {e}"
                                        )
                                    ...
                                    print(
                                        f"Product doesn't have an amine functional group"
                                    )
                    except Exception as e:
