        ...
        if (
            ...
            try:
                ...
                if product_mol and all(reactant_mols):
                    ...
                    print(
                        f"Ring formed: {ring_formed}, New heterocycle: {new_heterocycle_formed}"
                    )
                    print(
                        f"Reactant rings: {reactant_rings}, Product rings: {product_rings}"
                    )
                    ...
                    if is_nitro_reduction and has_nitro and has_amine and ring_formed:
                        ...
                        print(
                            f"Detected nitro reduction and cyclization at depth {depth}"
                        )
                    ...
                    if product_mol and all(reactant_mols):
                        ...
                        has_amine_reactant = any(
                            [
                                ...
                                or checker.check_fg(
                                    "Secondary amine", Chem.MolToSmiles(mol)
                                )
                                or checker.check_fg(
                                    "Tertiary amine", Chem.MolToSmiles(mol)
                                )
                            ...
                            for child in node.get("children", []):
                                if child["type"] == "reaction":
                                    try:
                                        ...
                                        child_reactants = child_rsmi.split(">")[
                                            0
                                        ].split(".")
                                        ...
                                        has_amine_child_product = (
                                            checker.check_fg(
                                                "Primary amine", child_product
                                            )
                                            or checker.check_fg(
                                                "Secondary amine", child_product
                                            )
                                            or checker.check_fg(
                                                "Tertiary amine", child_product
                                            )
                                            or checker.check_fg(
                                                "Aniline", child_product
                                            )
                                        )
