        ...
        if (
            ...
            if current_depth <= 1:  # Late stage (depth 0 or 1)
                try:
                    ...
                    if (
                        not is_nucleophilic_sub
                        and morpholine_reactant
                        and product_has_morpholine
                    ):
                        print(
                    ...
                    if is_nucleophilic_sub:
                        ...
                        if morpholine_reactant and product_has_morpholine:
                            ...
                            for other_reactant in other_reactants:
                                has_leaving_group = any(
                                    [
                                        checker.check_fg(
                                            "Primary halide", other_reactant
                                        ),
                                        checker.check_fg(
                                            "Secondary halide", other_reactant
                                        ),
                                        checker.check_fg(
                                            "Tertiary halide", other_reactant
                                        ),
                                        checker.check_fg("Tosylate", other_reactant),
                                        checker.check_fg("Mesylate", other_reactant),
                                        checker.check_fg("Triflate", other_reactant),
                                        "Cl"
                                        in other_reactant,  # Check for chlorine atom
                                        "Br"
                                        in other_reactant,  # Check for bromine atom
                                ...
                                if has_leaving_group:
                                    ...
                                    print(
                                        f"Other reactant with leaving group: {other_reactant}"
                                    )
                            ...
                            print(
                                f"Morpholine found in reactant but not in product: {product}"
                            )
                            ...
                            for reactant in reactants:
                                ...
                                ) and checker.check_fg("Primary alcohol", reactant):
                                    print(
                        ...
                        print(
                            f"Not a nucleophilic substitution reaction at depth {current_depth}"
                        )
