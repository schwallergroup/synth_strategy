            ...
            try:
                ...
                if depth == 0:
                    ...
                    if product_mol and final_mol:
                        if (
                            product_mol.GetNumHeavyAtoms()
                            != final_mol.GetNumHeavyAtoms()
                        ):
                ...
                for reactant in reactants:
                    ...
                    has_important_fg = any(
                        checker.check_fg(fg, reactant) for fg in important_fgs
                    )
                ...
                if len(substantial_reactants) >= 2:
                    ...
                    if is_coupling_reaction:
                        ...
                        if reactant_mols:
                            ...
                            product_atoms = (
                                product_mol.GetNumHeavyAtoms() if product_mol else 0
                            )
                            ...
                            if (
                                ...
                                for reactant in substantial_reactants:
                                    ...
                                    if r_mol and product_mol:
                                        ...
                                        min_atoms_threshold = min(
                                            r_mol.GetNumHeavyAtoms() * 0.7, 5
                                        )
