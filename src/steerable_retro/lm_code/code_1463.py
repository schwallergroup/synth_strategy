...
def main(route):
    ...
    def dfs_traverse(node, current_depth=0):
        ...
        if node["type"] == "reaction":
            ...
            depth_match = re.search(
                r"Depth: (\d+)", node.get("metadata", {}).get("ID", f"Depth: {current_depth}")
            )
            ...
            if checker.check_ring("benzimidazole", product):
                ...
                for reactant in reactants:
                    ...
                    if r_mol:
                        ...
                        if amine_count >= 2 and checker.check_fg("Primary amine", reactant):
                            has_diamine = True
            ...
            if depth <= 1:  # Late-stage coupling happens at low depths
                ...
                if checker.check_ring("benzimidazole", product):
                    ...
                    if checker.check_reaction("Suzuki", rsmi):
                    ...
                    elif checker.check_reaction("Suzuki coupling with boronic acids", rsmi):
                        late_stage_coupling = True
                        print(
                        ...
                        if has_boronic_acid and has_aryl_halide and has_benzimidazole_reactant:
                            late_stage_coupling = True
                            print(
            ...
            if depth >= 4:
                ...
                if checker.check_reaction(
                    ...
                    snar_reaction = True
                    print(f"Detected nucleophilic aromatic substitution at depth {depth}")
                else:
                    # Look for F/Cl/Br displacement by NH2 (nucleophilic aromatic substitution)
                    for reactant in reactants:
                        if checker.check_fg("Aromatic halide", reactant) and checker.check_fg(
    ...
    return benzimidazole_formation and late_stage_coupling and nitro_reduction and snar_reaction
