                ...
                try:
                        ...
                        for r in reactants_list:
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    is_alkylation = True
                                    print(f"Detected potential haloalkylation pattern manually")
                                    break
                    ...
                    if is_alkylation:
                        ...
                        for r in reactants_list:
                            ...
                            r_has_secondary_halide = checker.check_fg("Secondary halide", r)
                            r_has_tertiary_halide = checker.check_fg("Tertiary halide", r)
                        ...
                        for r in reactants_list:
                            ...
                            if (
                                ...
                                if checker.check_fg("Aldehyde", r) or checker.check_fg("Ketone", r):
                        ...
                        if product_has_halide and (reactant_has_halide or has_haloalkyl_pattern):
                            print(f"Detected late-stage haloalkylation in step at depth {depth}")
