...
def main(route):
                    ...
                    try:
                        ...
                        if product_n_methyl_count > reactant_n_methyl_count:
                            ...
                            if main_reactant.HasSubstructMatch(nitrogen_pattern):
                                print(f"Detected general methylation on nitrogen: {rsmi}")
                                return True
        ...
        try:
            ...
            for reactant in reactants:
                if checker.check_fg("Primary amine", reactant) or checker.check_fg(
                    ...
                    if checker.check_fg("Tertiary amine", product) or Chem.MolFromSmiles(
                        product
                    ).HasSubstructMatch(Chem.MolFromSmarts("[#7][CH3]")):
    ...
    print(f"Late-stage N-methylations: {late_stage_methylations} ({late_stage_percentage:.1%})")
