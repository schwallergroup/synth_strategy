...
def main(route):
    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "reaction" and "metadata" in node and "rsmi" in node["metadata"]:
            ...
            has_aromatic_reactant = any(checker.check_ring("benzene", r) for r in reactants)
            ...
            if has_aromatic_reactant and has_aromatic_product:
                ...
                if nitro_to_amine:
                    if checker.check_reaction("Reduction of nitro groups to amines", rsmi):
                        has_aromatic_n_functionalization = True
                        print(f"Detected nitro group reduction to amine (forward): {rsmi}")
                ...
                if n_containing_reactants or n_containing_product:
                    if (
                        checker.check_reaction("Formation of Azides from boronic acids", rsmi)
                        ...
                        has_aromatic_n_functionalization = True
                        print(f"Detected nitrogen functionalization on aromatic system: {rsmi}")
                ...
                if n_containing_reactants and n_containing_product:
                    ...
                    has_aromatic_n_functionalization = True
                    print(f"Detected interconversion between N-containing groups: {rsmi}")
