            ...
            if "rsmi" in node.get("metadata", {}):
                ...
                for reactant in reactants:
                    ...
                    if (
                        ...
                        print(f"Alkene to alcohol transformation found at depth {depth}")
                    ...
                    if (
                        ...
                        print(f"Alcohol to leaving group transformation found at depth {depth}")
                    ...
                    if (
                        ...
                        print(f"Leaving group to nitrile transformation found at depth {depth}")
