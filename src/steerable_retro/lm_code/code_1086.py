                ...
                if "[Br]" in reactant or "Br" in reactant:
                    ...
                    if reactant_mol and product_mol:
                        ...
                        if reactant_mol.HasSubstructMatch(
                            ...
                            br_count_reactant = len(reactant_mol.GetSubstructMatches(br_pattern))
                            br_count_product = len(product_mol.GetSubstructMatches(br_pattern))

                            cn_count_reactant = len(reactant_mol.GetSubstructMatches(cn_pattern))
                            cn_count_product = len(product_mol.GetSubstructMatches(cn_pattern))
