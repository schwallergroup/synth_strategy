        ...
        if node["type"] == "reaction":
            if "rsmi" in node.get("metadata", {}):
                ...
                if is_protection_reaction or is_deprotection_reaction:
                    ...
                    mol_to_check = product if is_protection_reaction else ".".join(reactants)

                    # Check for silyl protective group
                    has_silyl_group = checker.check_fg("Silyl protective group", mol_to_check)
                ...
                has_silyl_in_product = checker.check_fg("Silyl protective group", product)
                ...
                if not tbdms_protection_found:
                    ...
                    if has_silyl_in_product and not has_tbdms_in_product:
                        print("Silyl group detected in product but not TBDMS specifically")
                    if has_silyl_in_reactants and not has_tbdms_in_reactants:
                        print("Silyl group detected in reactants but not TBDMS specifically")
