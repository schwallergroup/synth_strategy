...
def main(route):
            ...
            if "rsmi" in node.get("metadata", {}):
                ...
                if checker.check_fg("Triflate", reactants_str) and not checker.check_fg(
                    ...
                    if (
                        ...
                        print(f"Detected triflate to biaryl transformation at depth {depth}")
                ...
                # 2. Phenol to triflate
                    ...
                    print(f"Detected phenol to triflate transformation at depth {depth}")
                ...
                # 3. Allyl ether to allyl phenol (Claisen rearrangement)
                    ...
                    if "allyl" in reactants_str.lower() or "CH2CH=CH2" in reactants_str:
                        transformation_sequence.append(("allyl_ether_to_allyl_phenol", depth))
                        print(
                ...
                # 4. Phenol to allyl ether (Williamson ether synthesis)
                    ...
                    if "allyl" in product_str.lower() or "CH2CH=CH2" in product_str:
                        if (
                            ...
                            transformation_sequence.append(("phenol_to_allyl_ether", depth))
                            print(f"Detected phenol to allyl ether transformation at depth {depth}")
    ...
    if len(transformations) == 1 and transformations[0] == "triflate_to_biaryl":
        ...
        if "allyl" in test_mol.lower() and "O" in test_mol:
            print("Special case: Found triflate_to_biaryl and molecule contains allyl and oxygen")
            return True
    ...
    print(f"All steps present: {all_steps_present}, In correct order: {in_correct_order}")
