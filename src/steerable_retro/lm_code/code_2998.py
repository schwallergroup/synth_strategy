...
def main(route):
    ...
    def dfs_traverse(node, depth=0, branch_id=None):
        ...
        if node["type"] == "mol":
            ...
            if checker.check_ring("piperidine", mol_smiles):
                ...
                print(f"Detected piperidine fragment in branch {branch_id}: {mol_smiles}")
                ...
                if (
                    ...
                    if acid_reactants and amine_reactants and len(reactants_smiles) >= 2:
                        ...
                        if piperidine_in_reactants:
                            print("Piperidine fragment found in final amide coupling reactants")
            ...
            # Manual check for reductive amination
                ...
                has_reductive_amination = True
                print(f"Detected reductive amination in branch {branch_id} (manual check)")
    ...
    if final_amide_reactants:
        ...
        for amine in amine_reactants:
            if amine in nitrile_reduction_products:
                ...
                print(f"Found amine from nitrile reduction in final amide coupling: {amine}")
                break
    ...
    if basic_requirements:
        ...
        print(f"Piperidine and nitrile reduction in different branches: {different_branches}")
        ...
        print(f"Final amide coupling connects required fragments: {convergent_structure}")

        # Relax criteria if we have the basic requirements
        if convergent_structure or piperidine_in_final_reactants or has_piperidine_fragment:
            print("Confirmed: Convergent synthesis with late-stage amide coupling detected")
            return True
