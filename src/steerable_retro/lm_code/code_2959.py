        ...
        if node["type"] == "reaction":
            if "rsmi" in node.get("metadata", {}):
                ...
                c_n_count_reactants = sum(
                    len(mol.GetSubstructMatches(c_n_pattern)) for mol in reactant_mols if mol
                )
                ...
                n_s_count_reactants = sum(
                    len(mol.GetSubstructMatches(n_s_pattern)) for mol in reactant_mols if mol
                )
                ...
                c_o_count_reactants = sum(
                    len(mol.GetSubstructMatches(c_o_pattern)) for mol in reactant_mols if mol
                )
