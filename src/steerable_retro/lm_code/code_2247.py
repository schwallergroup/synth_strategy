        ...
        if node["type"] == "reaction" and depth <= 1:
            try:
                ...
                if checker.check_reaction(
                    ...
                    is_amide_coupling = True
                    print(f"Found amide coupling at depth {depth}: Schotten-Baumann reaction")
                elif checker.check_reaction("Acyl chloride with secondary amine to amide", rsmi):
                    is_amide_coupling = True
                    print(
                        f"Found amide coupling at depth {depth}: Acyl chloride with secondary amine"
                    )
                elif checker.check_reaction("Carboxylic acid with primary amine to amide", rsmi):
                    is_amide_coupling = True
                    print(f"Found amide coupling at depth {depth}: Carboxylic acid with amine")
                elif checker.check_reaction("Ester with primary amine to amide", rsmi):
                    is_amide_coupling = True
                    print(f"Found amide coupling at depth {depth}: Ester with primary amine")
                elif checker.check_reaction("Ester with secondary amine to amide", rsmi):
                    is_amide_coupling = True
                    print(f"Found amide coupling at depth {depth}: Ester with secondary amine")
                elif checker.check_reaction("Acyl chloride with ammonia to amide", rsmi):
                    is_amide_coupling = True
                    print(f"Found amide coupling at depth {depth}: Acyl chloride with ammonia")
                    ...
                    is_amide_coupling = True
                    print(f"Found amide coupling at depth {depth}: Acylation of primary amines")
                elif checker.check_reaction("Acylation of secondary amines", rsmi):
                    is_amide_coupling = True
                    print(f"Found amide coupling at depth {depth}: Acylation of secondary amines")
                elif checker.check_reaction("{Schotten-Baumann_amide}", rsmi):
                    is_amide_coupling = True
                    print(f"Found amide coupling at depth {depth}: Schotten-Baumann amide")
                ...
                if not is_amide_coupling:
                    ...
                    if has_acyl_donor and has_amine and has_amide_product:
                        ...
                        is_amide_coupling = True
                        print(f"Found amide coupling at depth {depth}: Generic amide formation")
