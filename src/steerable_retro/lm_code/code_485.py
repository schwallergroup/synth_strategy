...
def main(route):
    ...
    def dfs_traverse(node):
        ...
        if node["type"] == "reaction":
            ...
            if (
                any(r is not None and r.HasSubstructMatch(phenol_pattern) for r in reactants)
            ...
            if (
                any(r is not None and r.HasSubstructMatch(allyl_ether_pattern) for r in reactants)
                and product is not None
