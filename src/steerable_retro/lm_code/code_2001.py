...
def main(route):
    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "reaction":
            ...
            print(f"Found {significant_fragments} significant fragments at depth {depth}")
            ...
            if not first_step_processed:
                ...
                print(f"Ring count: reactants={reactant_ring_count}, product={product_ring_count}")
                ...
                # Also check for known cyclization reaction types
                    ...
                    has_final_cyclization = True
                    print("Found cyclization in final step (known cyclization reaction)")
