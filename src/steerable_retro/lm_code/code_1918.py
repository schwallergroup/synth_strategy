    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "mol":
            ...
            if checker.check_fg("Aniline", mol_smiles):
                print(f"Tracking aromatic amine as potential diazonium precursor: {mol_smiles}")
            ...
            for reactant in reactants:
                ...
                if "ONO" in reactant or "NO2" in reactant or checker.check_fg("Nitroso", reactant):
            ...
            if has_aromatic_amine and has_nitrite_source:
                print(f"Detected potential diazonium formation conditions in reaction: {rsmi}")
                has_diazonium_chemistry = True
                return
