...
def main(route):
    """
    This function detects if the synthesis route includes an ester hydrolysis step.
    """
            ...
            if "rsmi" in node.get("metadata", {}):
                try:
                    ...
                    if checker.check_reaction(
                        ...
                        # As a fallback, check for ester in reactants and acid in product
                        has_ester = any(
                        ...
                        if has_ester and has_acid:
                            print(f"Found potential ester hydrolysis: {rsmi}")
                            print(f"Ester in reactants: {has_ester}, Acid in product: {has_acid}")
                            found_ester_hydrolysis = True
