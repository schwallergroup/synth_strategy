...
def main(route):
        ...
        if node["type"] == "mol":
            ...
            try:
                ...
                if is_amide_formation:
                    ...
                    has_amide_in_product = checker.check_fg("Secondary amide", product_smiles)
                ...
                for reactant in reactants_smiles:
                    ...
                    elif checker.check_ring("cyclohexane", reactant) and checker.check_fg(
    ...
    print(f"Pyridine elaboration with amide linkage strategy detection result: {strategy_present}")
