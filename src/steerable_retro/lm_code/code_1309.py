            ...
            if is_late_stage:
                ...
                if is_n_alkylation:
                    ...
                    if product_heterocycles:
                        print(f"Nitrogen heterocycles found in product: {product_heterocycles}")
                        ...
                        for reactant in reactants:
                            ...
                            if reactant_heterocycles:
                                ...
                                if checker.check_fg("Secondary amine", reactant):
                                    print(f"Secondary amine found in reactant with heterocycle")
                                ...
                                # Check if the reactant has a primary amine in the heterocycle
                                    ...
                                    print(f"Primary amine found in reactant with heterocycle")
                                    n_alkylation_detected = True
                                    break
