...
def main(route):
                ...
                if not is_benzylic_functionalization:
                    ...
                    if product and all(reactants):
                        ...
                        if product.HasSubstructMatch(benzylic_pattern):
                            benzylic_matches = product.GetSubstructMatches(benzylic_pattern)
                            benzylic_carbons = [
                        ...
                        if (
                            ...
                            is_benzylic_functionalization = True
                            print(f"Detected general benzylic functionalization at depth {depth}")
    ...
    print(f"Late-stage benzylic functionalization strategy detected: {strategy_present}")
