...
def main(route):
    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "reaction" and "metadata" in node and "rsmi" in node["metadata"]:
            ...
            if any(checker.check_fg("Carboxylic acid", r) for r in reactants) and checker.check_fg(
                ...
                print(f"Found acid to acid chloride conversion at depth {depth}: {rsmi}")
    ...
    print(f"Vinyl to aldehyde found: {found_vinyl_to_aldehyde} at depth {vinyl_to_aldehyde_depth}")
    print(f"Aldehyde to acid found: {found_aldehyde_to_acid} at depth {aldehyde_to_acid_depth}")
    print(
