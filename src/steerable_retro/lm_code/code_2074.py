                ...
                if len(reactants) >= 2:
                    ...
                    if not is_n_alkylation:
                        ...
                        if has_amine:
                            ...
                            elif any(checker.check_fg("Primary amine", r) for r in reactants) and (
                                checker.check_fg("Secondary amine", product)
                                or checker.check_fg("Tertiary amine", product)
                            ):
                                has_more_substituted_amine = True

                        is_n_alkylation = has_amine and has_halide and has_more_substituted_amine
                    ...
                    for reactant in reactants:
                        # Check for amine
                        if checker.check_fg("Secondary amine", reactant) or checker.check_fg(
                        ...
                        if has_halide and has_heterocycle:
                            print(f"Found halide-substituted heterocycle in reactant: {reactant}")
                    ...
                    if amine_reactant and halide_heterocycle_reactant:
                        ...
                        if has_n_alkylation_product and amine_complex and heterocycle_complex:
                            found_pattern = True
                            print("Found late-stage convergent N-alkylation pattern")
                        else:
                            if not has_n_alkylation_product:
                                print("Product does not contain expected N-alkylation result")
                            else:
                                print(
