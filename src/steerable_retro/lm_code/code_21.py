                    ...
                    if product_mol and checker.check_ring("indole", product):
                        ...
                        for reactant in reactants:
                            if checker.check_ring("indole", reactant):
                                ...
                                if "[nH]" in reactant or "n1" in reactant and "H" in reactant:
                            ...
                            if checker.check_ring("cyclohexane", reactant):
                                ...
                                if any(halide in reactant for halide in ["Br", "Cl", "I"]):
                                    print(f"Found cyclohexylmethyl halide in reactant: {reactant}")
                        ...
                        if depth == 11 and indole_found and cyclohexylmethyl_found:
                            ...
                            if "[nH]" in indole_reactant and "Br" in cyclohexylmethyl_reactant:
                                # Check if the product has the indole N connected to cyclohexylmethyl
                                if checker.check_ring("indole", product) and checker.check_ring(
                                    "cyclohexane", product
                                ):
                                    if (
