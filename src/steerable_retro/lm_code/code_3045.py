                    ...
                    for reactant in reactants:
                        for ring in cyclic_amine_rings:
                            if checker.check_ring(ring, reactant):
                                ...
                                print(f"Found cyclic amine ({ring}) in reactant: {reactant}")
                                break
                    ...
                    for reactant in reactants:
                        ...
                        for ring in heteroaromatic_rings:
                            if checker.check_ring(ring, reactant):
                                ...
                                print(f"Found heteroaromatic ring ({ring}) in reactant: {reactant}")
                                break
                        ...
                        if hetero_ring_found and has_halogen:
                            ...
                            print(f"Found halogenated heteroaromatic in reactant: {reactant}")
                            break
                    ...
                    if cyclic_amine_reactant and halogen_hetero_reactant:
                        ...
                        for ring in cyclic_amine_rings:
                            if checker.check_ring(ring, product):
                                ...
                                print(f"Product contains cyclic amine ({ring}): {product}")
                                break

                        for ring in heteroaromatic_rings:
                            if checker.check_ring(ring, product):
                                product_has_heteroaromatic = True
                                print(f"Product contains heteroaromatic ring ({ring}): {product}")
                                break
                        ...
                        try:
                            ...
                            if (
                                ...
                                and hetero_mol
                                and product_mol.GetNumAtoms() > cyclic_amine_mol.GetNumAtoms()
