...
def main(route):
        ...
        if node["type"] == "reaction":
            ...
            if product and all(r for r in reactants):
                ...
                if (
                    ...
                    reactant_rings_total = sum(r.GetRingInfo().NumRings() for r in reactants if r)
                ...
                product_has_chloride = product and product.HasSubstructMatch(chloride_pattern)
    ...
    print(f"Fused heterocycle with late-stage SNAr strategy detected: {strategy_present}")
