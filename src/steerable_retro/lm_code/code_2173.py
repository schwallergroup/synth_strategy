            ...
            try:
                ...
                if product_mol:
                    ...
                    if any(
                        ...
                        print("Detected primary amine to secondary amine transformation")
                        primary_to_secondary = True

                    # Secondary to tertiary transformation
                    if any(
                        r and r.HasSubstructMatch(secondary_amine) for r in reactants if r
                    ) and product_mol.HasSubstructMatch(tertiary_amine):
                        print("Detected secondary amine to tertiary amine transformation")
