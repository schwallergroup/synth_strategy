...
def main(route):
    ...
    is_late_stage_incorporation = thiazolidinedione_depth >= 0 and thiazolidinedione_depth <= 1

    print(f"Late-stage thiazolidinedione incorporation detected: {is_late_stage_incorporation}")
