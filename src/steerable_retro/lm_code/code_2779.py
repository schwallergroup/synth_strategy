    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "mol" and node.get("in_stock", False):
            if checker.check_fg("Acetal/Ketal", node["smiles"]):
                in_stock_ketal = True
                print(f"In-stock molecule with ketal found at depth {depth}: {node['smiles']}")
                ...
                try:
                    ...
                    if not ketal_found:
                        ...
                        if (
                            ...
                            and not any(checker.check_fg("Acetal/Ketal", r) for r in reactants if r)
                        ):
                            ketal_found = True
                            print(f"Ketal protection found (fallback) at depth {depth}: {rsmi}")
                    ...
                    if not ketal_deprotection_found:
                        ...
                        if (
                            ...
                            ketal_deprotection_found = True
                            print(f"Ketal deprotection found (fallback) at depth {depth}: {rsmi}")
