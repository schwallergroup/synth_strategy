...
def main(route):
    ...
    def dfs_traverse(node, depth=0):
        if node["type"] == "reaction":
            ...
            if reactants_count >= 2 and depth <= 2:  # Focus on reactions in the first few steps
    ...
    if is_convergent:
        print(f"Detected convergent synthesis with branch points at depths: {branch_depths}")
