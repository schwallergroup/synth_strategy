...
def main(route):
        ...
        if node["type"] == "reaction" and "metadata" in node and "rsmi" in node["metadata"]:
            ...
            try:
                ...
                if reactants_mol and product_mol:
                    ...
                    reactants_amide_count = len(reactants_mol.GetSubstructMatches(amide_pattern))
    ...
    dfs_traverse(route)
    return amide_formation_count >= 2  # Return True if at least 2 amide formations detected
