        ...
        if node["type"] == "reaction" and depth <= 2:
            ...
            try:
                ...
                if not is_amide_formation:
                    ...
                    if amine_reactant_idx is not None and carbonyl_reactant_idx is not None:
                        ...
                        if has_amide:
                            ...
                            has_primary_amine = checker.check_fg("Primary amine", amine_reactant)
                            ...
                            has_acyl_halide = checker.check_fg("Acyl halide", carbonyl_reactant)
                            has_carboxylic_acid = checker.check_fg(
                                "Carboxylic acid", carbonyl_reactant
                            )
                            has_ester = checker.check_fg("Ester", carbonyl_reactant)

                            print(f"Amine reactant: {has_primary_amine or has_secondary_amine}")
                            print(
