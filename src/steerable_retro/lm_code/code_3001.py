    ...
    def dfs_traverse(node):
        ...
        if node["type"] == "reaction":
            ...
            if not is_reductive_amination:
                ...
                has_tertiary_amine_product = checker.check_fg("Tertiary amine", product_smiles)
                ...
                print(f"Manual check - Tertiary amine in product: {has_tertiary_amine_product}")

                # Check for reducing agents in the reagents section
                reagents = rsmi.split(">")[1].split(".")
                reducing_agents = ["NaBH4", "NaBH3CN", "NaCNBH3", "BC#N", "B", "H", "[HH]", "H2"]
            ...
            if is_reductive_amination:
                ...
                # Special case: check if secondary amine forms tertiary amine
                    ...
                    has_reductive_amination = True
                    print("Confirmed reductive amination: secondary amine to tertiary amine")
