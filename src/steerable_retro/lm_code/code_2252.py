        ...
        if node["type"] == "reaction":
            try:
                ...
                if (
                    ...
                    print(f"Found potential phenol alkylation reaction at depth {depth}")

                    # Verify that a phenol is involved in the reaction
                    phenol_in_reactants = any(
                        checker.check_fg("Phenol", r) or checker.check_fg("Aromatic alcohol", r)
                        for r in reactants
                    )
                ...
                # Check for O-alkylation reactions that might not be categorized specifically
                    ...
                    phenol_reactant_indices = [
                        ...
                        if checker.check_fg("Phenol", r) or checker.check_fg("Aromatic alcohol", r)
                    ]
                    ...
                    if phenol_reactant_indices and alkylating_agent_present:
                        print(f"Found phenol and alkylating agent in reactants at depth {depth}")
                        ...
                        if checker.check_fg("Ether", product):
                            ...
                            if product_mol:
                                ...
                                if has_aromatic:
                                    print(f"Confirmed aryl ether formation at depth {depth}")
                                    phenol_alkylation_found = True
