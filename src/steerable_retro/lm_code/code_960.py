    ...
    if not redox_sequence_found:
        for i in range(len(depths) - 1):
            ...
            for j in range(i + 1, min(i + 3, len(depths))):
                ...
                if checker.check_fg("Primary alcohol", current_product) or checker.check_fg(
                    "Secondary alcohol", current_product
                ):
                    ...
                    if (
                        ...
                        if j + 1 < len(depths) and depths[j + 1] - next_depth <= 2:
                            ...
                            ) or checker.check_fg("Secondary alcohol", next_next_product):
                                print(
                    ...
                    if checker.check_fg("Primary alcohol", next_product):
                        ...
                        if j + 1 < len(depths) and depths[j + 1] - next_depth <= 2:
                            ...
                            if (
                                ...
                                or checker.check_fg("Carboxylic acid", next_next_product)
