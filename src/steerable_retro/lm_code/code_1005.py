    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "reaction" and "metadata" in node and "rsmi" in node["metadata"]:
            ...
            if depth == 1:
                ...
                product_has_secondary_amide = checker.check_fg("Secondary amide", product)
                ...
                if product_has_amide:
                    ...
                    if not reactants_all_have_same_amide:
                        print("Amide was formed in this reaction (not present in all reactants)")
                        ...
                        has_anhydride = any(
                            checker.check_fg("Anhydride", reactant) for reactant in reactants
                        )
                        ...
                        has_ammonia = "N" in reactants_part and not any(
                            atom for atom in "BCDEFGHIJKLOPQRSTUVWXYZ" if atom in reactants_part
                        )
