...
def main(route):
    ...
    def dfs_traverse(node):
        ...
        if node["type"] == "reaction":
            ...
            has_epoxide = any(
                Chem.MolFromSmiles(r) and Chem.MolFromSmiles(r).HasSubstructMatch(epoxide_pattern)
                for r in reactants
                if r
            )
            ...
            no_epoxide = product_mol and not product_mol.HasSubstructMatch(epoxide_pattern)
