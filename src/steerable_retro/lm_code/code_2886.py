    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "reaction" and depth == 1:
            try:
                ...
                print(f"Analyzing potential final step reaction at depth {depth}: {rsmi}")
                ...
                if not final_step_is_amide_coupling:
                    ...
                    has_secondary_amide = checker.check_fg("Secondary amide", product_part)
                    has_tertiary_amide = checker.check_fg("Tertiary amide", product_part)
                    ...
                    if has_acid_derivative and has_amine and has_amide:
                        print(f"Found amide coupling as final step (via functional group analysis)")
                        final_step_is_amide_coupling = True
                        return
