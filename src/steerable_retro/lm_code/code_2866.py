...
def main(route):
    ...
    potential_linker_molecules = set()  # Track molecules that might contain linker precursors
    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "mol":
            ...
            all_reactants_have_ether = all(checker.check_fg("Ether", r) for r in reactants if r)
            ...
            if checker.check_reaction("Williamson Ether Synthesis", rsmi):
                ...
                if has_alcohol and has_alkyl_halide and connects_functional_groups(product):
                    print(
            ...
            # Check for esterification reactions that could be part of linker installation
                ...
                if checker.check_fg("Ester", product) and checker.check_fg("Ether", product):
