                ...
                if not (has_ring_opening and has_ester_formation):
                    ...
                    for reactant in reactants:
                        ...
                        if reactant_mol and product_mol:
                            ...
                            has_acid_reactant = checker.check_fg("Carboxylic acid", reactant)
                            has_acid_product = checker.check_fg("Carboxylic acid", product)

                            if ring_change and (
                                (has_ester_reactant and (has_ester_product or has_acid_product))
                                or (has_acid_reactant and has_ester_product)
                            ):
                                has_ring_opening = True
                                has_ester_formation = True
                                print(f"Found general ring opening with ester involvement: {rsmi}")
