...
def main(route):
        ...
        if node["type"] == "reaction" and "metadata" in node and "rsmi" in node["metadata"]:
            ...
            try:
                ...
                if (
                    (
                        is_reductive_amination
                        or (has_formaldehyde and has_primary_amine and has_tertiary_amine_product)
                    )
                    ...
                    print(f"Confirmed reductive amination forming tertiary amine at depth {depth}")
    ...
    print(f"Late-stage reductive amination detected: {has_reductive_amination and late_stage}")
