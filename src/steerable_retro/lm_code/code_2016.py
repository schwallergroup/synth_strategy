...
def main(route):
            ...
            if "rsmi" in node.get("metadata", {}):
                ...
                for reactant in reactants:
                    ...
                    if mol:
                        ...
                        if mol.HasSubstructMatch(aryl_halide_pattern) or mol.HasSubstructMatch(
                            heteroaryl_halide_pattern
                        ):
    ...
    dfs_traverse(route)
    return sonogashira_count >= 2  # Return True if at least 2 Sonogashira couplings detected
