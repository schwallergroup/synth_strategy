    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "reaction" and depth <= 1:  # Late stage (depth 0 or 1)
            if "rsmi" in node.get("metadata", {}):
                ...
                if reactant_has_ester and product_has_acid and (is_esterification or is_hydrolysis):
                ...
                # do a more general check for ester to acid transformation
                    ...
                    print(f"Potential ester to acid transformation detected at depth {depth}")
