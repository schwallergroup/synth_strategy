    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "reaction" and "metadata" in node and "rsmi" in node["metadata"]:
            ...
            if depth <= 2:
                ...
                print(f"Is reductive amination by reaction check: {is_reductive_amination}")
                ...
                try:
                    ...
                    if len(reactants) >= 2:
                        ...
                        if has_amine and has_carbonyl:
                            print(f"Confirmed fragment coupling via reductive amination")
                            found_pattern = True
                        ...
                        # If reaction check failed but we have the right reactants, try to detect manually
                            ...
                            if checker.check_fg("Tertiary amine", product) or checker.check_fg(
                        ...
                        if depth == 1 and not found_pattern:
                            ...
                            if any(checker.check_fg("Aldehyde", r) for r in reactants) and any(
                                ...
                                if checker.check_fg("Tertiary amine", product) or checker.check_fg(
                                    ...
                                    print("Detected reductive amination pattern at depth 1")
                                    found_pattern = True
