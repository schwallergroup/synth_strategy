                    ...
                    if product_mol:
                        ...
                        if product_mol.HasSubstructMatch(methoxyethoxy_ether_pattern):
                            ...
                            if alcohol_mol:
                                ...
                                print(f"Alcohol protection with methoxyethoxy group confirmed")
                        else:
                            print(f"Product does not contain methoxyethoxy ether group: {product}")
            else:
                        ...
                        if product_mol.HasSubstructMatch(methoxyethoxy_pattern):
                            ...
                            for reactant in reactants:
                                ...
                                if reactant_mol:
                                    ...
                                    if reactant_mol.HasSubstructMatch(methoxyethoxy_halide_pattern):
                                        print(f"Methoxyethoxy halide found in reactant: {reactant}")
                                        protection_found = True
                                        print(
            ...
            if not protection_found:
                for reactant in reactants:
                    if (
                        ...
                        or "ClCH2OCH2CH3" in Chem.MolToSmiles(Chem.MolFromSmiles(reactant))
                        ...
                        for r in reactants:
                            if (
                                ...
                                if "OCH2OCH2CH3" in product or "OCH2OCH2CH3" in Chem.MolToSmiles(
                ...
                if (
                    ...
                    print(f"Found specific methoxyethoxy protection pattern in reaction")
                    protection_found = True
