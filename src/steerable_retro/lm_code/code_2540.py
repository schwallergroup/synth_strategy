...
def main(route):
    ...
    strategy_case1 = boc_protection_depth is not None and boc_actually_added and boc_maintained

    # Case 2: Boc present in starting material and maintained
    strategy_case2 = starting_material_has_boc and final_product_has_boc and boc_maintained
