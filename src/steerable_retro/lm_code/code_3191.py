                            ...
                            if checker.check_fg("Nitrile", r_smi):
                                ...
                                if mol:
                                    ...
                                    if "[Cu]" in r_smi and "#" in r_smi:
                                        print(f"Detected copper cyanide reagent: {r_smi}")
                                        continue
                                    if "Na" in r_smi and "#" in r_smi and len(r_smi) < 10:
                                        print(f"Detected sodium cyanide reagent: {r_smi}")
                                        continue
                                    if "K" in r_smi and "#" in r_smi and len(r_smi) < 10:
                                        print(f"Detected potassium cyanide reagent: {r_smi}")
                                        continue
                                    ...
                                    print(f"Reactant has nitrile functional group: {r_smi}")
