...
def main(route):
    """
    This function detects nitro reduction to amine.
    Looks for a reaction where a nitro group is transformed to an amine.
    """
            ...
            if "rsmi" in node.get("metadata", {}):
                ...
                for reactant in reactants:
                    ...
                    if reactant_mol and reactant_mol.HasSubstructMatch(
                        ...
                        # Check if product contains amine at similar position
