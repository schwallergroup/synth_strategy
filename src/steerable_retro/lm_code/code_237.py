...
def main(route):
    ...
    def dfs_traverse(node, depth=0, path=None):
        ...
        if node["type"] == "mol":
            ...
            aryl_halide_reactants = [r for r in reactants if checker.check_fg("Aromatic halide", r)]
            ...
            if aryl_halide_reactants and has_ester_product:
                print(f"Found potential aryl halide to ester conversion at depth {depth}")
                ...
                if not conversion_found:
                    print("No specific reaction type matched, checking general transformation...")
                    ...
                    for r in aryl_halide_reactants:
                        if not checker.check_fg("Ester", r) and has_ester_product:
                            print("General aryl halide to ester transformation detected")
                            conversion_found = True
                            break
