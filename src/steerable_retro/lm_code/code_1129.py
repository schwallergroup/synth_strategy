        ...
        if node["type"] == "reaction" and node.get("metadata", {}).get("rsmi"):
            ...
            if depth <= 2:  # Late stage reactions
                ...
                if (
                    ...
                    has_pyridine = len(pyridine_only_reactants) > 0 or len(pyridine_reactants) > 0
                    has_hydrazine = len(hydrazine_reactants) > 0
                    has_carbonyl = len(carbonyl_reactants) > 0

                    print(f"Has quinoline: {has_quinoline}, Has pyridine: {has_pyridine}")
                    print(f"Has hydrazine: {has_hydrazine}, Has carbonyl: {has_carbonyl}")
                    ...
                    if (
                        ...
                        if product_has_quinoline and product_has_pyridine:
                            ...
                            if not any(checker.check_fg("Hydrazone", r) for r in reactants_smiles):
