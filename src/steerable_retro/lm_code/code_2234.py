...
def main(route):
            ...
            if "rsmi" in node.get("metadata", {}):
                ...
                for reactant in reactants:
                    if checker.check_fg("Carbamic ester", reactant):
                        ...
                        if prod_mol is not None and not checker.check_fg("Carbamic ester", product):
                            ...
                            if (
                                ...
                                print(f"Found Cbz deprotection step at depth {depth}, rsmi: {rsmi}")
                                deprotection_depths.append(depth)
                                break
                            ...
                            if "OH" in rsmi or "H2O" in rsmi or "NaOH" in rsmi or "KOH" in rsmi:
    ...
    if has_protection and has_deprotection:
        ...
        for p_depth in protection_depths:
            for d_depth in deprotection_depths:
                if p_depth > d_depth:  # Protection occurs earlier in synthesis than deprotection
                    valid_sequence = True
                    break
            if valid_sequence:
                break
    ...
    print(f"Protection depths: {protection_depths}, Deprotection depths: {deprotection_depths}")
