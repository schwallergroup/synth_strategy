            ...
            if "metadata" in node and "rsmi" in node["metadata"]:
                    ...
                    try:
                        ...
                        if (
                            ...
                            if has_carboxylic_acid and has_amine:
                                amide_formation = True
                                amide_depth = depth
                                print(f"Found amide formation (manual check) at depth {depth}")
                ...
                if not coupling_found:
                    try:
                        ...
                        has_halide = any(checker.check_fg("Aromatic halide", r) for r in reactants)

                        if has_boronic and has_halide:
                            coupling_reaction = True
                            coupling_depth = depth
                            print(f"Found coupling reaction (manual Suzuki check) at depth {depth}")
                    except Exception as e:
