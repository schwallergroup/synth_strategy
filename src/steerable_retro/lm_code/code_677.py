...
def main(route):
        ...
        if node["type"] == "reaction":
            ...
            if product and reactants:
                ...
                if not nitro_reduction_found:
                    ...
                    product_has_amine = product and product.HasSubstructMatch(amine_pattern)
                    product_has_no_nitro = product and not product.HasSubstructMatch(nitro_pattern)
    ...
    strategy_present = nitro_reduction_found and sulfonamide_formation_found and correct_sequence
