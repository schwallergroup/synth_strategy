...
def main(route) -> Tuple[bool, Dict]:
    """
    Detects a synthetic strategy that uses both N-Boc protection and deprotection within the same route. This is achieved by identifying reactions that match names from the predefined lists BOC_PROTECTION_REACTIONS and BOC_DEPROTECTION_REACTIONS.
    """
    findings_template = {
        "atomic_checks": {
            "named_reactions": [],
    ...
    # Track if we find N-Boc protection and deprotection
    ...
    def dfs_traverse(node, depth=0):
        ...
        if boc_protection_found and boc_deprotection_found:
            return
    ...
    # Add structural constraint if both protection and deprotection are found
    if result:
        findings_json["structural_constraints"].append({
            ...
            "details": {
                ...
                "description": "The route must contain at least one reaction from the Boc protection list and at least one reaction from the Boc deprotection list."
            }
        })
