...
# Refactoring for Enumeration: Isolate the lists of named reactions.
...
def main(route) -> Tuple[bool, Dict]:
    ...
    result = boc_protection_found or boc_deprotection_found

    if result:
        # Add the structural constraint if any Boc reaction is found
        findings_json["structural_constraints"].append({
            "type": "count",
            "details": {
                "target": "any_boc_reaction",
                "operator": ">=",
                "value": 1
            }
        })
