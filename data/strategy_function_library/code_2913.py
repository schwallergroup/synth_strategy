...
def main(route) -> Tuple[bool, Dict]:
    """
    Detects a late-stage amide coupling reaction by checking if the final step matches a reaction from a predefined list of amide formation transformations, including 'Acylation of Nitrogen Nucleophiles by Carboxylic Acids', 'Schotten-Baumann_amide', and others.
    """
    findings_template = {
        "atomic_checks": {
            "named_reactions": [],
    ...
    def dfs_traverse(node, depth=0):
        ...
        if node["type"] == "reaction":
            ...
            if depth <= 1:
                ...
                # Check if this is a known amide coupling reaction
