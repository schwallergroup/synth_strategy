...
def main(route) -> Tuple[bool, Dict]:
    """
    Detects if the route involves esterification in the late stage of synthesis
    (depth 0 or 1 in the retrosynthetic tree)
    """
    findings_template = {
        "atomic_checks": {
            "named_reactions": [],
    ...
    print(f"Late-stage esterification strategy detected: {has_late_esterification}")
