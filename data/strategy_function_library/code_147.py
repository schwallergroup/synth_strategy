...
def main(route) -> Tuple[bool, Dict]:
    ...
    def dfs_traverse(node, depth=0):
        nonlocal found_deprotection, findings_json
            ...
            if has_tert_butyl_ester and checker.check_fg("Carboxylic acid", product):
                ...
                if product_mol:
                    ...
                    if not product_mol.HasSubstructMatch(tert_butyl_pattern):
                        ...
                        # Add structural constraints if deprotection is confirmed
                        ...
                        findings_json["structural_constraints"].append({
                            "type": "negation",
                            "details": {
                                "target": "tert-butyl ester",
                                "scope": "product_of_reaction"
                            }
                        })
                        if "tert-butyl ester deprotection" not in findings_json["atomic_checks"]["named_reactions"]:
                            findings_json["atomic_checks"]["named_reactions"].append("tert-butyl ester deprotection")
    ...
    dfs_traverse(route)
    return found_deprotection, findings_json
