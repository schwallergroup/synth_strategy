...
def main(route) -> Tuple[bool, Dict]:
    """
    This function detects a late-stage amide coupling strategy by checking for a specific list of named reactions, including various acylations and Schotten-Baumann type reactions, in the final step of the synthesis.
    """
    findings_template = {
        "atomic_checks": {
            "named_reactions": [],
    ...
    def dfs_traverse(node, depth=0):
        nonlocal is_late_stage_amide_coupling, findings_json
    ...
    dfs_traverse(route)
    return is_late_stage_amide_coupling, findings_json
