...
def main(route) -> Tuple[bool, Dict]:
    """
    Detects late-stage amide coupling by checking for a specific set of reactions at a depth of 1 or less. The reactions checked are defined in the AMIDE_COUPLING_REACTIONS list.
    """
    findings_template = {
        "atomic_checks": {
            "named_reactions": [],
    ...
    def dfs_traverse(node, depth=0):
        nonlocal late_stage_amide_coupling_detected, findings_json
    ...
    dfs_traverse(route)
    return late_stage_amide_coupling_detected, findings_json
